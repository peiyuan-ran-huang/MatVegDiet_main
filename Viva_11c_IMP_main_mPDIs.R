...
# This script is to perform main association analysis (with imputed data) for MODIFIED plant-based diet indices (mPDIs) in Project Viva.
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_bin,
  "results/Viva/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_bin.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_bin <-
  read.xlsx("results/Viva/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_bin.xlsx")
...
write.xlsx(obs.res_PDI_bin,
           "results/Viva/IMP_MAIN_obs.res_PDIm_bin.xlsx",
           overwrite = T)
obs.res_PDI_bin <-
  read.xlsx("results/Viva/IMP_MAIN_obs.res_PDIm_bin.xlsx")
...
write.xlsx(obs.res_hPDI_bin,
           "results/Viva/IMP_MAIN_obs.res_hPDIm_bin.xlsx",
           overwrite = T)
obs.res_hPDI_bin <-
  read.xlsx("results/Viva/IMP_MAIN_obs.res_hPDIm_bin.xlsx")
...
write.xlsx(obs.res_uPDI_bin,
           "results/Viva/IMP_MAIN_obs.res_uPDIm_bin.xlsx",
           overwrite = T)
obs.res_uPDI_bin <-
  read.xlsx("results/Viva/IMP_MAIN_obs.res_uPDIm_bin.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_bin,
  file = "results/Viva/IMP_MAIN_obs.forest_PDIm.hPDIm.uPDIm_bin.png",
  height = 10,
  width = 7
)
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_con,
  "results/Viva/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_con.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_con <-
  read.xlsx("results/Viva/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_con.xlsx")
...
write.xlsx(obs.res_PDI_con,
           "results/Viva/IMP_MAIN_obs.res_PDIm_con.xlsx",
           overwrite = T)
obs.res_PDI_con <-
  read.xlsx("results/Viva/IMP_MAIN_obs.res_PDIm_con.xlsx")
...
write.xlsx(obs.res_hPDI_con,
           "results/Viva/IMP_MAIN_obs.res_hPDIm_con.xlsx",
           overwrite = T)
obs.res_hPDI_con <-
  read.xlsx("results/Viva/IMP_MAIN_obs.res_hPDIm_con.xlsx")
...
write.xlsx(obs.res_uPDI_con,
           "results/Viva/IMP_MAIN_obs.res_uPDIm_con.xlsx",
           overwrite = T)
obs.res_uPDI_con <-
  read.xlsx("results/Viva/IMP_MAIN_obs.res_uPDIm_con.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_con,
  file = "results/Viva/IMP_MAIN_obs.forest_PDIm.hPDIm.uPDIm_con.png",
  height = 2,
  width = 7
)
