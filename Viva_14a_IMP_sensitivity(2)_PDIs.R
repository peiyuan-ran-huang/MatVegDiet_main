...
for (myoutcome in Viva_out_bin) {
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_MID.p_bin"]] + dat[[i]][["energy_Mat_MID.p_con"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_6[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_MID.p_bin"]] + dat[[i]][["energy_Mat_MID.p_con"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_9[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_MID.p_bin"]] + dat[[i]][["energy_Mat_MID.p_con"]],
        family = binomial
      )
  }
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_bin,
  "results/Viva/IMP_SENS.MID.p_obs.tbl_PDI.hPDI.uPDI_bin.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_bin <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.tbl_PDI.hPDI.uPDI_bin.xlsx")
...
write.xlsx(obs.res_PDI_bin,
           "results/Viva/IMP_SENS.MID.p_obs.res_PDI_bin.xlsx",
           overwrite = T)
obs.res_PDI_bin <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_PDI_bin.xlsx")
...
write.xlsx(
  obs.res_hPDI_bin,
  "results/Viva/IMP_SENS.MID.p_obs.res_hPDI_bin.xlsx",
  overwrite = T
)
obs.res_hPDI_bin <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_hPDI_bin.xlsx")
...
write.xlsx(
  obs.res_uPDI_bin,
  "results/Viva/IMP_SENS.MID.p_obs.res_uPDI_bin.xlsx",
  overwrite = T
)
obs.res_uPDI_bin <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_uPDI_bin.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_bin,
  file = "results/Viva/IMP_SENS.MID.p_obs.forest_PDI.hPDI.uPDI_bin.png",
  height = 10,
  width = 7
)
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_con,
  "results/Viva/IMP_SENS.MID.p_obs.tbl_PDI.hPDI.uPDI_con.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_con <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.tbl_PDI.hPDI.uPDI_con.xlsx")
...
write.xlsx(obs.res_PDI_con,
           "results/Viva/IMP_SENS.MID.p_obs.res_PDI_con.xlsx",
           overwrite = T)
obs.res_PDI_con <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_PDI_con.xlsx")
...
write.xlsx(
  obs.res_hPDI_con,
  "results/Viva/IMP_SENS.MID.p_obs.res_hPDI_con.xlsx",
  overwrite = T
)
obs.res_hPDI_con <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_hPDI_con.xlsx")
...
write.xlsx(
  obs.res_uPDI_con,
  "results/Viva/IMP_SENS.MID.p_obs.res_uPDI_con.xlsx",
  overwrite = T
)
obs.res_uPDI_con <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_uPDI_con.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_con,
  file = "results/Viva/IMP_SENS.MID.p_obs.forest_PDI.hPDI.uPDI_con.png",
  height = 3,
  width = 7
)
...
for (i in 1:dat_imp$m) {
  mod_3[[i]] <-
    clm(
      bf_dur_4c ~ PDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin + any.supp_Mat_MID.p_bin,
      data = dat[[i]]
    )
}
mod_3_pooled <- pool(mod_3)
...
for (i in 1:dat_imp$m) {
  mod_6[[i]] <-
    clm(
      bf_dur_4c ~ hPDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin + any.supp_Mat_MID.p_bin,
      data = dat[[i]]
    )
}
mod_6_pooled <- pool(mod_6)
...
for (i in 1:dat_imp$m) {
  mod_9[[i]] <-
    clm(
      bf_dur_4c ~ uPDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin + any.supp_Mat_MID.p_bin,
      data = dat[[i]]
    )
}
mod_9_pooled <- pool(mod_9)
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_ord,
  "results/Viva/IMP_SENS.MID.p_obs.tbl_PDI.hPDI.uPDI_ord.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_ord <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.tbl_PDI.hPDI.uPDI_ord.xlsx")
...
write.xlsx(obs.res_PDI_ord,
           "results/Viva/IMP_SENS.MID.p_obs.res_PDI_ord.xlsx",
           overwrite = T)
obs.res_PDI_ord <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_PDI_ord.xlsx")
...
write.xlsx(
  obs.res_hPDI_ord,
  "results/Viva/IMP_SENS.MID.p_obs.res_hPDI_ord.xlsx",
  overwrite = T
)
obs.res_hPDI_ord <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_hPDI_ord.xlsx")
...
write.xlsx(
  obs.res_uPDI_ord,
  "results/Viva/IMP_SENS.MID.p_obs.res_uPDI_ord.xlsx",
  overwrite = T
)
obs.res_uPDI_ord <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_obs.res_uPDI_ord.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_ord,
  file = "results/Viva/IMP_SENS.MID.p_obs.forest_PDI.hPDI.uPDI_ord.png",
  height = 2,
  width = 7
)
