...
# Last edited date: 09-Nov-2024
# This script is to perform sensitivity analysis (with imputed data) for vegetarian diets in ALSPAC.
...
for (myoutcome in ALSPAC_out_bin) {
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin_FFQ_self"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin_FFQ_self"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]] + dat[[i]][["hPDIm"]],
        family = binomial
      )
  }
...
write.xlsx(
  obs.tbl_VegDiet_bin,
  "results/ALSPAC/IMP_SENS.FFQ.self_obs.tbl_VegDiet_bin.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_bin <-
  read.xlsx("results/ALSPAC/IMP_SENS.FFQ.self_obs.tbl_VegDiet_bin.xlsx")
...
obs.res_VegDiet_bin
dim(obs.res_VegDiet_bin)  # 21 outcomes * 1 category * 3 models = 63 obs.
write.xlsx(
  obs.res_VegDiet_bin,
  "results/ALSPAC/IMP_SENS.FFQ.self_obs.res_VegDiet_bin.xlsx",
  overwrite = T
)
obs.res_VegDiet_bin <-
  read.xlsx("results/ALSPAC/IMP_SENS.FFQ.self_obs.res_VegDiet_bin.xlsx")
...
head(obs.res_VegDiet_bin)
dim(obs.res_VegDiet_bin)  # 21 -> 21 obs.
################################################################################
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/ALSPAC/IMP_SENS.FFQ.self_obs.forest_VegDiet_bin.png",
  height = 5,
  width = 8
)
...
for (myoutcome in ALSPAC_out_con) {
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin_FFQ_self"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]] + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_2_pooled <- pool(mod_2)
...
obs.tbl_VegDiet_con
dim(obs.tbl_VegDiet_con)  # 4 outcomes for 2 categories in 3 models = 8 obs.
write.xlsx(
  obs.tbl_VegDiet_con,
  "results/ALSPAC/IMP_SENS.FFQ.self_obs.tbl_VegDiet_con.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_con <-
  read.xlsx("results/ALSPAC/IMP_SENS.FFQ.self_obs.tbl_VegDiet_con.xlsx")
...
write.xlsx(
  obs.res_VegDiet_con,
  "results/ALSPAC/IMP_SENS.FFQ.self_obs.res_VegDiet_con.xlsx",
  overwrite = T
)
obs.res_VegDiet_con <-
  read.xlsx("results/ALSPAC/IMP_SENS.FFQ.self_obs.res_VegDiet_con.xlsx")
...
ggsave(
  obs.forest_VegDiet_con,
  file = "results/ALSPAC/IMP_SENS.FFQ.self_obs.forest_VegDiet_con.png",
  height = 2,
  width = 6
)
...
for (i in 1:dat_imp$m) {
  mod_2[[i]] <-
    clm(
      bf_dur_4c ~ VegDiet_bin_FFQ_self + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + IMD_Fam_cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + sex_Chi_bin,
      data = dat[[i]]
    )
}
mod_2_pooled <- pool(mod_2)
...
for (i in 1:dat_imp$m) {
  mod_3[[i]] <-
    clm(
      bf_dur_4c ~ VegDiet_bin_FFQ_self + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + IMD_Fam_cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + sex_Chi_bin + any.supp_Mat_EAR.p_bin + hPDIm,
      data = dat[[i]]
    )
}
mod_3_pooled <- pool(mod_3)
...
write.xlsx(
  obs.tbl_VegDiet_ord,
  "results/ALSPAC/IMP_SENS.FFQ.self_obs.tbl_VegDiet_ord.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_ord <-
  read.xlsx("results/ALSPAC/IMP_SENS.FFQ.self_obs.tbl_VegDiet_ord.xlsx")
...
write.xlsx(
  obs.res_VegDiet_ord,
  "results/ALSPAC/IMP_SENS.FFQ.self_obs.res_VegDiet_ord.xlsx",
  overwrite = T
)
obs.res_VegDiet_ord <-
  read.xlsx("results/ALSPAC/IMP_SENS.FFQ.self_obs.res_VegDiet_ord.xlsx")
