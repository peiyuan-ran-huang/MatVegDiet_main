...
# This script is to perform main association analysis (with imputed data) for vegetarian diets (in subgroups) in BiB.
...
for (myoutcome in BiB_out_bin) {
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_3cat"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]],
        family = binomial
      )
  }
...
obs.tbl_VegDiet_bin
dim(obs.tbl_VegDiet_bin) # 19 outcomes * 3 categories = 57 obs in 3 models
write.xlsx(
  obs.tbl_VegDiet_bin,
  "results/BiB/IMP_MAIN_obs.tbl_VegDiet.subgroup_bin.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_bin <-
  read.xlsx("results/BiB/IMP_MAIN_obs.tbl_VegDiet.subgroup_bin.xlsx")
...
obs.res_VegDiet_bin
dim(obs.res_VegDiet_bin)  # 19 outcomes * 2 categories * 3 models = 114 obs.
write.xlsx(
  obs.res_VegDiet_bin,
  "results/BiB/IMP_MAIN_obs.res_VegDiet.subgroup_bin.xlsx",
  overwrite = T
)
obs.res_VegDiet_bin <-
  read.xlsx("results/BiB/IMP_MAIN_obs.res_VegDiet.subgroup_bin.xlsx")
...
dim(obs.res_VegDiet_bin)  # 19 outcomes * 2 categories * 1 model = 38 obs.
...
head(obs.res_VegDiet_bin)
dim(obs.res_VegDiet_bin)  # 38 -> 30 obs.
################################################################################
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/BiB/IMP_MAIN_obs.forest_VegDiet.subgroup_bin.png",
  height = 8,
  width = 8
)
...
for (myoutcome in BiB_out_con) {
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_3cat"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]] + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]])
  }
  mod_3_pooled <- pool(mod_3)
...
write.xlsx(
  obs.tbl_VegDiet_con,
  "results/BiB/IMP_MAIN_obs.tbl_VegDiet.subgroup_con.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_con <-
  read.xlsx("results/BiB/IMP_MAIN_obs.tbl_VegDiet.subgroup_con.xlsx")
...
write.xlsx(
  obs.res_VegDiet_con,
  "results/BiB/IMP_MAIN_obs.res_VegDiet.subgroup_con.xlsx",
  overwrite = T
)
obs.res_VegDiet_con <-
  read.xlsx("results/BiB/IMP_MAIN_obs.res_VegDiet.subgroup_con.xlsx")
...
ggsave(
  obs.forest_VegDiet_con,
  file = "results/BiB/IMP_MAIN_obs.forest_VegDiet.subgroup_con.png",
  height = 3,
  width = 6
)
