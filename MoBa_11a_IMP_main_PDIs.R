...
# This script is to perform main association analysis (with imputed data) for plant-based diet indices (PDIs) in MoBa.
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_bin,
  "results/IMP_MAIN_obs.tbl_PDI.hPDI.uPDI_bin.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_bin <-
  read.xlsx("results/IMP_MAIN_obs.tbl_PDI.hPDI.uPDI_bin.xlsx")
...
write.xlsx(obs.res_PDI_bin,
           "results/IMP_MAIN_obs.res_PDI_bin.xlsx",
           overwrite = T)
obs.res_PDI_bin <-
  read.xlsx("results/IMP_MAIN_obs.res_PDI_bin.xlsx")
...
write.xlsx(obs.res_hPDI_bin,
           "results/IMP_MAIN_obs.res_hPDI_bin.xlsx",
           overwrite = T)
obs.res_hPDI_bin <-
  read.xlsx("results/IMP_MAIN_obs.res_hPDI_bin.xlsx")
...
write.xlsx(obs.res_uPDI_bin,
           "results/IMP_MAIN_obs.res_uPDI_bin.xlsx",
           overwrite = T)
obs.res_uPDI_bin <-
  read.xlsx("results/IMP_MAIN_obs.res_uPDI_bin.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_bin,
  file = "results/IMP_MAIN_obs.forest_PDI.hPDI.uPDI_bin.png",
  height = 12,
  width = 7
)
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_con,
  "results/IMP_MAIN_obs.tbl_PDI.hPDI.uPDI_con.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_con <-
  read.xlsx("results/IMP_MAIN_obs.tbl_PDI.hPDI.uPDI_con.xlsx")
...
write.xlsx(obs.res_PDI_con,
           "results/IMP_MAIN_obs.res_PDI_con.xlsx",
           overwrite = T)
obs.res_PDI_con <-
  read.xlsx("results/IMP_MAIN_obs.res_PDI_con.xlsx")
...
write.xlsx(obs.res_hPDI_con,
           "results/IMP_MAIN_obs.res_hPDI_con.xlsx",
           overwrite = T)
obs.res_hPDI_con <-
  read.xlsx("results/IMP_MAIN_obs.res_hPDI_con.xlsx")
...
write.xlsx(obs.res_uPDI_con,
           "results/IMP_MAIN_obs.res_uPDI_con.xlsx",
           overwrite = T)
obs.res_uPDI_con <-
  read.xlsx("results/IMP_MAIN_obs.res_uPDI_con.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_con,
  file = "results/IMP_MAIN_obs.forest_PDI.hPDI.uPDI_con.png",
  height = 3,
  width = 7
)
