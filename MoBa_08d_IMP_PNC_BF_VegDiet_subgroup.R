...
# This script is to perform paternal negative control analysis on breastfeeding duration (with imputed data) for vegetarian diets (in subgroups) in MoBa.
...
for (i in 1:dat_imp$m) {
  mod_1[[i]] <-
    clm(dat[[i]][["bf_dur_4c"]] ~ dat[[i]][["VegDiet_3cat"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
}
...
for (i in 1:dat_imp$m) {
  mod_2[[i]] <-
    clm(
      dat[[i]][["bf_dur_4c"]] ~ dat[[i]][["VegDiet_3cat"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["VegDiet_3cat_Pat"]] + dat[[i]][["age_Pat_con"]] + dat[[i]][["edu_Pat_3cat"]] + dat[[i]][["parity_Pat_bin"]] + dat[[i]][["BMI_Pat_EAR.p_con"]] + dat[[i]][["smoking_Pat_EAR.p_bin"]] + dat[[i]][["alcohol_Pat_EAR.p_bin"]] + dat[[i]][["any.supp_Pat_EAR.p_bin"]]
    )
}
...
for (i in 1:dat_imp$m) {
  mod_3[[i]] <-
    clm(dat[[i]][["bf_dur_4c"]] ~ dat[[i]][["VegDiet_3cat_Pat"]] + dat[[i]][["age_Pat_con"]] + dat[[i]][["edu_Pat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Pat_bin"]] + dat[[i]][["BMI_Pat_EAR.p_con"]] + dat[[i]][["smoking_Pat_EAR.p_bin"]] + dat[[i]][["alcohol_Pat_EAR.p_bin"]] + dat[[i]][["any.supp_Pat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
}
...
write.xlsx(
  obs.tbl_VegDiet_ord,
  "results/IMP_PNC_BF_obs.tbl_VegDiet.subgroup_ord.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_ord <-
  read.xlsx("results/IMP_PNC_BF_obs.tbl_VegDiet.subgroup_ord.xlsx")
...
write.xlsx(
  obs.res_VegDiet_ord,
  "results/IMP_PNC_BF_obs.res_VegDiet.subgroup_ord.xlsx",
  overwrite = T
)
obs.res_VegDiet_ord <-
  read.xlsx("results/IMP_PNC_BF_obs.res_VegDiet.subgroup_ord.xlsx")
