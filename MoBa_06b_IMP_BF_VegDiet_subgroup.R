...
# This script is to perform negative control outcome analysis on breastfeeding (with imputed data) for vegetarian diets (in subgroups) in MoBa.
...
write.xlsx(
  obs.tbl_VegDiet_ord,
  "results/IMP_BF_obs.tbl_VegDiet.subgroup_ord.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_ord <-
  read.xlsx("results/IMP_BF_obs.tbl_VegDiet.subgroup_ord.xlsx")
...
write.xlsx(
  obs.res_VegDiet_ord,
  "results/IMP_BF_obs.res_VegDiet.subgroup_ord.xlsx",
  overwrite = T
)
obs.res_VegDiet_ord <-
  read.xlsx("results/IMP_BF_obs.res_VegDiet.subgroup_ord.xlsx")
...
write.xlsx(
  obs.res_VegDiet_SEP,
  "results/IMP_BF_obs.res_VegDiet.subgroup_SEP.xlsx",
  overwrite = T
)
obs.res_VegDiet_SEP <-
  read.xlsx("results/IMP_BF_obs.res_VegDiet.subgroup_SEP.xlsx")
...
obs.forest_VegDiet_SEP <- ggforestplot::forestplot(
  ...
  shape = Outcome,
  xlab = "OR and 95% CI",
  title = "Effect of socioeconomic position in MoBa",
  logodds = T
) +
...
ggsave(
  obs.forest_VegDiet_SEP,
  file = "results/IMP_BF_obs.forest_VegDiet.subgroup_SEP.png",
  height = 3,
  width = 9
)
