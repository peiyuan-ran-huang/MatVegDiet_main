...
# Last edited date: 31-Jul-2025
# This script is to perform main association analysis (with imputed data) for MODIFIED plant-based diet indices (mPDIs) in MoBa.
...
for (myoutcome in MoBa_out_bin) {
  ...
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDIm_z"]], family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["PDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_4[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDIm_z"]], family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_5[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_6[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["hPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_7[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDIm_z"]], family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_8[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_9[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["uPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
  ...
  x <-
    cbind(
      ...
      N = as.data.frame(c(
        paste0(nrow(dat_1[!is.na(dat_1[["PDIm_z"]]) &
                            !is.na(dat_1[[myoutcome]]) &
                            dat_1[[myoutcome]] == 1, ]), " / ", nrow(dat_1[!is.na(dat_1[["PDIm_z"]]) &
                                                                             !is.na(dat_1[[myoutcome]]), ])),
        paste0(nrow(dat_1[!is.na(dat_1[["hPDIm_z"]]) &
                            !is.na(dat_1[[myoutcome]]) &
                            dat_1[[myoutcome]] == 1, ]), " / ", nrow(dat_1[!is.na(dat_1[["hPDIm_z"]]) &
                                                                             !is.na(dat_1[[myoutcome]]), ])),
        paste0(nrow(dat_1[!is.na(dat_1[["uPDIm_z"]]) &
                            !is.na(dat_1[[myoutcome]]) &
                            dat_1[[myoutcome]] == 1, ]), " / ", nrow(dat_1[!is.na(dat_1[["uPDIm_z"]]) &
                                                                             !is.na(dat_1[[myoutcome]]), ]))
      )),
...
obs.tbl_PDI.hPDI.uPDI_bin
dim(obs.tbl_PDI.hPDI.uPDI_bin)  # 22 outcomes * 3 exposures = 66 obs
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_bin,
  "results/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_bin.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_bin <-
  read.xlsx("results/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_bin.xlsx")
...
obs.res_PDI_bin
dim(obs.res_PDI_bin)  # 22 outcomes * 3 models = 66 obs
write.xlsx(obs.res_PDI_bin,
           "results/IMP_MAIN_obs.res_PDIm_bin.xlsx",
           overwrite = T)
obs.res_PDI_bin <-
  read.xlsx("results/IMP_MAIN_obs.res_PDIm_bin.xlsx")
...
obs.res_hPDI_bin
dim(obs.res_hPDI_bin)  # 22 outcomes * 3 models = 66 obs
write.xlsx(obs.res_hPDI_bin,
           "results/IMP_MAIN_obs.res_hPDIm_bin.xlsx",
           overwrite = T)
obs.res_hPDI_bin <-
  read.xlsx("results/IMP_MAIN_obs.res_hPDIm_bin.xlsx")
...
obs.res_uPDI_bin
dim(obs.res_uPDI_bin)  # 22 outcomes * 3 models = 66 obs
write.xlsx(obs.res_uPDI_bin,
           "results/IMP_MAIN_obs.res_uPDIm_bin.xlsx",
           overwrite = T)
obs.res_uPDI_bin <-
  read.xlsx("results/IMP_MAIN_obs.res_uPDIm_bin.xlsx")
...
obs.res_PDI.hPDI.uPDI_bin$Outcome <-
  factor(obs.res_PDI.hPDI.uPDI_bin$Outcome,
         levels = unique(MRPREG_outcome_labels$label)[unique(MRPREG_outcome_labels$label) %in% obs.res_PDI.hPDI.uPDI_bin$Outcome])
obs.res_PDI.hPDI.uPDI_bin <-
  obs.res_PDI.hPDI.uPDI_bin %>% arrange(Outcome)  # Make sure the outcomes appear in the right order
...
dim(obs.res_PDI.hPDI.uPDI_bin)  # 22 outcomes * 3 exposures * 1 model = 66 obs
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_bin,
  file = "results/IMP_MAIN_obs.forest_PDIm.hPDIm.uPDIm_bin.png",
  height = 12,
  width = 7
)
...
for (myoutcome in MoBa_out_con) {
  ...
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDIm_z"]])
  }
  mod_1_pooled <- pool(mod_1)
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_2_pooled <- pool(mod_2)
  ...
  for (i in 1:dat_imp$m) {
    mod_4[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDIm_z"]])
  }
  mod_4_pooled <- pool(mod_4)
  ...
  for (i in 1:dat_imp$m) {
    mod_5[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_5_pooled <- pool(mod_5)
  ...
  for (i in 1:dat_imp$m) {
    mod_7[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDIm_z"]])
  }
  mod_7_pooled <- pool(mod_7)
  ...
  for (i in 1:dat_imp$m) {
    mod_8[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_8_pooled <- pool(mod_8)
  ...
  x <-
    cbind(
      ...
      Exposure = as.data.frame(c("PDI", "hPDI", "uPDI")),
      N = as.data.frame(c(
        nrow(dat_1[!is.na(dat_1[["PDIm_z"]]) &
                     !is.na(dat_1[[myoutcome]]), ]), nrow(dat_1[!is.na(dat_1[["hPDIm_z"]]) &
                                                                  !is.na(dat_1[[myoutcome]]), ]), nrow(dat_1[!is.na(dat_1[["uPDIm_z"]]) &
                                                                                                               !is.na(dat_1[[myoutcome]]), ])
      )),
      Model_1 = rbind(x_1, x_4, x_7),
      space = " ",
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_con,
  "results/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_con.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_con <-
  read.xlsx("results/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_con.xlsx")
...
write.xlsx(obs.res_PDI_con,
           "results/IMP_MAIN_obs.res_PDIm_con.xlsx",
           overwrite = T)
obs.res_PDI_con <-
  read.xlsx("results/IMP_MAIN_obs.res_PDIm_con.xlsx")
...
write.xlsx(obs.res_hPDI_con,
           "results/IMP_MAIN_obs.res_hPDIm_con.xlsx",
           overwrite = T)
obs.res_hPDI_con <-
  read.xlsx("results/IMP_MAIN_obs.res_hPDIm_con.xlsx")
...
write.xlsx(obs.res_uPDI_con,
           "results/IMP_MAIN_obs.res_uPDIm_con.xlsx",
           overwrite = T)
obs.res_uPDI_con <-
  read.xlsx("results/IMP_MAIN_obs.res_uPDIm_con.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_con,
  file = "results/IMP_MAIN_obs.forest_PDIm.hPDIm.uPDIm_con.png",
  height = 3,
  width = 7
)
