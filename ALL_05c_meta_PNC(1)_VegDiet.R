...
## Part 1: Maternal Model 1 and Paternal Model 1
...
obs.res_VegDiet_bin_ALSPAC <-
  read.xlsx("ALSPAC/PNC_obs.res_VegDiet_bin.xlsx")
...
obs.res_VegDiet_con_ALSPAC <-
  read.xlsx("ALSPAC/PNC_obs.res_VegDiet_con.xlsx")
...
obs.res_VegDiet_ord_ALSPAC <-
  read.xlsx("ALSPAC/PNC_BF_obs.res_VegDiet_ord.xlsx")
...
obs.res_VegDiet_bin_MoBa <-
  read.xlsx("MoBa/PNC_obs.res_VegDiet_bin.xlsx")
...
obs.res_VegDiet_con_MoBa <-
  read.xlsx("MoBa/PNC_obs.res_VegDiet_con.xlsx")
...
obs.res_VegDiet_ord_MoBa <-
  read.xlsx("MoBa/PNC_BF_obs.res_VegDiet_ord.xlsx")
...
## Separate results for Maternal Model 1 / Paternal Model 1
obs.res_VegDiet_bin_Mat <- subset(obs.res_VegDiet_bin, Model == "Maternal Model 1")
obs.res_VegDiet_bin_Pat <- subset(obs.res_VegDiet_bin, Model == "Paternal Model 1")

obs.res_VegDiet_con_Mat <- subset(obs.res_VegDiet_con, Model == "Maternal Model 1")
obs.res_VegDiet_con_Pat <- subset(obs.res_VegDiet_con, Model == "Paternal Model 1")

obs.res_VegDiet_ord_Mat <- subset(obs.res_VegDiet_ord, Model == "Maternal Model 1")
obs.res_VegDiet_ord_Pat <- subset(obs.res_VegDiet_ord, Model == "Paternal Model 1")
...
write.xlsx(
  metagen_obs.tbl_VegDiet_bin_Mat,
  "ALL/PNC_meta.tbl_VegDiet_bin_Mat1.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Mat1.png",
  res = 300,
  height = 6700,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Mat1_Preg.png",
  res = 300,
  height = 2000,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Mat1_Deli.png",
  res = 300,
  height = 3800,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Mat1_Post.png",
  res = 300,
  height = 1300,
  width = 2600
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_bin_Pat,
  "ALL/PNC_meta.tbl_VegDiet_bin_Pat1.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Pat1.png",
  res = 300,
  height = 6700,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Pat1_Preg.png",
  res = 300,
  height = 2000,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Pat1_Deli.png",
  res = 300,
  height = 3800,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Pat1_Post.png",
  res = 300,
  height = 1300,
  width = 2600
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_con_Mat,
  "ALL/PNC_meta.tbl_VegDiet_con_Mat1.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_con_Mat1.png",
  res = 300,
  height = 1650,
  width = 2100
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_con_Pat,
  "ALL/PNC_meta.tbl_VegDiet_con_Pat1.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_con_Pat1.png",
  res = 300,
  height = 1650,
  width = 2100
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_ord_Mat,
  "ALL/PNC_meta.tbl_VegDiet_ord_Mat1.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_ord_Mat1.png",
  res = 300,
  height = 600,
  width = 2100
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_ord_Pat,
  "ALL/PNC_meta.tbl_VegDiet_ord_Pat1.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_ord_Pat1.png",
  res = 300,
  height = 600,
  width = 2100
)
