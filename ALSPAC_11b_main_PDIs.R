...
# Last edited date: 29-Jul-2024
# This script is to perform main association analysis for plant-based diet indices (PDIs) in ALSPAC.
...
for (myoutcome in ALSPAC_out_bin) {
  ...
  mod_2 <-
    glm(dat[[myoutcome]] ~ dat[["PDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]],
        family = binomial)
  ...
  mod_3 <-
    glm(dat[[myoutcome]] ~ dat[["PDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]] + dat[["any.supp_Mat_EAR.p_bin"]] + dat[["energy_Mat_DUR.p_con"]],
        family = binomial)
  ...
  #### Model 2 - Additionally adjusting for sociodemographic, pregnancy-related, and lifestyle factors
  mod_5 <-
    glm(dat[[myoutcome]] ~ dat[["hPDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]],
        family = binomial)
  ...
  #### Model 3 - Additionally adjusting for nutrition-related factors
  mod_6 <-
    glm(dat[[myoutcome]] ~ dat[["hPDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]] + dat[["any.supp_Mat_EAR.p_bin"]] + dat[["energy_Mat_DUR.p_con"]],
        family = binomial)
  ...
  #### Model 2 - Additionally adjusting for sociodemographic, pregnancy-related, and lifestyle factors
  mod_8 <-
    glm(dat[[myoutcome]] ~ dat[["uPDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]],
        family = binomial)
  ...
  #### Model 3 - Additionally adjusting for nutrition-related factors
  mod_9 <-
    glm(dat[[myoutcome]] ~ dat[["uPDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]] + dat[["any.supp_Mat_EAR.p_bin"]] + dat[["energy_Mat_DUR.p_con"]],
        family = binomial)
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_bin,
  "results/ALSPAC/MAIN_obs.tbl_PDI.hPDI.uPDI_bin.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_bin <-
  read.xlsx("results/ALSPAC/MAIN_obs.tbl_PDI.hPDI.uPDI_bin.xlsx")
...
write.xlsx(obs.res_PDI_bin,
           "results/ALSPAC/MAIN_obs.res_PDI_bin.xlsx",
           overwrite = T)
obs.res_PDI_bin <-
  read.xlsx("results/ALSPAC/MAIN_obs.res_PDI_bin.xlsx")
...
write.xlsx(obs.res_hPDI_bin,
           "results/ALSPAC/MAIN_obs.res_hPDI_bin.xlsx",
           overwrite = T)
obs.res_hPDI_bin <-
  read.xlsx("results/ALSPAC/MAIN_obs.res_hPDI_bin.xlsx")
...
write.xlsx(obs.res_uPDI_bin,
           "results/ALSPAC/MAIN_obs.res_uPDI_bin.xlsx",
           overwrite = T)
obs.res_uPDI_bin <-
  read.xlsx("results/ALSPAC/MAIN_obs.res_uPDI_bin.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_bin,
  file = "results/ALSPAC/MAIN_obs.forest_PDI.hPDI.uPDI_bin.png",
  height = 12,
  width = 7
)
...
for (myoutcome in ALSPAC_out_con) {
  ...
  #### Model 2 - Additionally adjusting for sociodemographic, pregnancy-related, and lifestyle factors
  mod_2 <-
    lm(dat[[myoutcome]] ~ dat[["PDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]])
  x_2 <- extract_lin.res_con(mod_2)
  y_2 <- extract_beta.SE_con(mod_2)
  
  #### Model 3 - Additionally adjusting for nutrition-related factors
  mod_3 <-
    lm(dat[[myoutcome]] ~ dat[["PDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]] + dat[["any.supp_Mat_EAR.p_bin"]] + dat[["energy_Mat_DUR.p_con"]])
  ...
  #### Model 2 - Additionally adjusting for sociodemographic, pregnancy-related, and lifestyle factors
  mod_5 <-
    lm(dat[[myoutcome]] ~ dat[["hPDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]])
  x_5 <- extract_lin.res_con(mod_5)
  y_5 <- extract_beta.SE_con(mod_5)
  
  #### Model 3 - Additionally adjusting for nutrition-related factors
  mod_6 <-
    lm(dat[[myoutcome]] ~ dat[["hPDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]] + dat[["any.supp_Mat_EAR.p_bin"]] + dat[["energy_Mat_DUR.p_con"]])
  ...
  #### Model 2 - Additionally adjusting for sociodemographic, pregnancy-related, and lifestyle factors
  mod_8 <-
    lm(dat[[myoutcome]] ~ dat[["uPDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]])
  x_8 <- extract_lin.res_con(mod_8)
  y_8 <- extract_beta.SE_con(mod_8)
  
  #### Model 3 - Additionally adjusting for nutrition-related factors
  mod_9 <-
    lm(dat[[myoutcome]] ~ dat[["uPDI_z"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]] + dat[["any.supp_Mat_EAR.p_bin"]] + dat[["energy_Mat_DUR.p_con"]])
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_con,
  "results/ALSPAC/MAIN_obs.tbl_PDI.hPDI.uPDI_con.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_con <-
  read.xlsx("results/ALSPAC/MAIN_obs.tbl_PDI.hPDI.uPDI_con.xlsx")
...
write.xlsx(obs.res_PDI_con,
           "results/ALSPAC/MAIN_obs.res_PDI_con.xlsx",
           overwrite = T)
obs.res_PDI_con <-
  read.xlsx("results/ALSPAC/MAIN_obs.res_PDI_con.xlsx")
...
write.xlsx(obs.res_hPDI_con,
           "results/ALSPAC/MAIN_obs.res_hPDI_con.xlsx",
           overwrite = T)
obs.res_hPDI_con <-
  read.xlsx("results/ALSPAC/MAIN_obs.res_hPDI_con.xlsx")
...
write.xlsx(obs.res_uPDI_con,
           "results/ALSPAC/MAIN_obs.res_uPDI_con.xlsx",
           overwrite = T)
obs.res_uPDI_con <-
  read.xlsx("results/ALSPAC/MAIN_obs.res_uPDI_con.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_con,
  file = "results/ALSPAC/MAIN_obs.forest_PDI.hPDI.uPDI_con.png",
  height = 3,
  width = 7
)
