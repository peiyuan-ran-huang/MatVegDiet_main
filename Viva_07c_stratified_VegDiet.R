...
# This script is to perform stratification analyses for vegetarian diets in Project Viva.
...
write.xlsx(
  obs.res_VegDiet_bin,
  "results/Viva/STRAT.iron_obs.res_VegDiet_bin.xlsx",
  overwrite = T
)
obs.res_VegDiet_bin <-
  read.xlsx("results/Viva/STRAT.iron_obs.res_VegDiet_bin.xlsx")
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/Viva/STRAT.iron_obs.forest_VegDiet_bin.png",
  height = 2,
  width = 6
)
