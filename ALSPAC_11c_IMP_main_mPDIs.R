...
# Last edited date: 30-Jul-2025
# This script is to perform main association analysis (with imputed data) for MODIFIED plant-based diet indices (mPDIs) in ALSPAC.
...
for (myoutcome in ALSPAC_out_bin) {
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["PDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_5[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_6[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["hPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_8[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_9[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["uPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_bin,
  "results/ALSPAC/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_bin.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_bin <-
  read.xlsx("results/ALSPAC/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_bin.xlsx")
...
write.xlsx(obs.res_PDI_bin,
           "results/ALSPAC/IMP_MAIN_obs.res_PDIm_bin.xlsx",
           overwrite = T)
obs.res_PDI_bin <-
  read.xlsx("results/ALSPAC/IMP_MAIN_obs.res_PDIm_bin.xlsx")
...
write.xlsx(obs.res_hPDI_bin,
           "results/ALSPAC/IMP_MAIN_obs.res_hPDIm_bin.xlsx",
           overwrite = T)
obs.res_hPDI_bin <-
  read.xlsx("results/ALSPAC/IMP_MAIN_obs.res_hPDIm_bin.xlsx")
...
write.xlsx(obs.res_uPDI_bin,
           "results/ALSPAC/IMP_MAIN_obs.res_uPDIm_bin.xlsx",
           overwrite = T)
obs.res_uPDI_bin <-
  read.xlsx("results/ALSPAC/IMP_MAIN_obs.res_uPDIm_bin.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_bin,
  file = "results/ALSPAC/IMP_MAIN_obs.forest_PDIm.hPDIm.uPDIm_bin.png",
  height = 12,
  width = 7
)
...
for (myoutcome in ALSPAC_out_con) {
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_2_pooled <- pool(mod_2)
  ...
  for (i in 1:dat_imp$m) {
    mod_5[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_5_pooled <- pool(mod_5)
  ...
  for (i in 1:dat_imp$m) {
    mod_8[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDIm_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_8_pooled <- pool(mod_8)
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_con,
  "results/ALSPAC/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_con.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_con <-
  read.xlsx("results/ALSPAC/IMP_MAIN_obs.tbl_PDIm.hPDIm.uPDIm_con.xlsx")
...
write.xlsx(obs.res_PDI_con,
           "results/ALSPAC/IMP_MAIN_obs.res_PDIm_con.xlsx",
           overwrite = T)
obs.res_PDI_con <-
  read.xlsx("results/ALSPAC/IMP_MAIN_obs.res_PDIm_con.xlsx")
...
write.xlsx(obs.res_hPDI_con,
           "results/ALSPAC/IMP_MAIN_obs.res_hPDIm_con.xlsx",
           overwrite = T)
obs.res_hPDI_con <-
  read.xlsx("results/ALSPAC/IMP_MAIN_obs.res_hPDIm_con.xlsx")
...
write.xlsx(obs.res_uPDI_con,
           "results/ALSPAC/IMP_MAIN_obs.res_uPDIm_con.xlsx",
           overwrite = T)
obs.res_uPDI_con <-
  read.xlsx("results/ALSPAC/IMP_MAIN_obs.res_uPDIm_con.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_con,
  file = "results/ALSPAC/IMP_MAIN_obs.forest_PDIm.hPDIm.uPDIm_con.png",
  height = 3,
  width = 7
)
