...
# This script is to perform negative control outcome analysis on breastfeeding for plant-based diet indices (PDIs) in ALSPAC.
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_ord,
  "results/ALSPAC/BF_obs.tbl_PDI.hPDI.uPDI_ord.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_ord <-
  read.xlsx("results/ALSPAC/BF_obs.tbl_PDI.hPDI.uPDI_ord.xlsx")
...
write.xlsx(obs.res_PDI_ord,
           "results/ALSPAC/BF_obs.res_PDI_ord.xlsx",
           overwrite = T)
obs.res_PDI_ord <-
  read.xlsx("results/ALSPAC/BF_obs.res_PDI_ord.xlsx")
...
write.xlsx(obs.res_hPDI_ord,
           "results/ALSPAC/BF_obs.res_hPDI_ord.xlsx",
           overwrite = T)
obs.res_hPDI_ord <-
  read.xlsx("results/ALSPAC/BF_obs.res_hPDI_ord.xlsx")
...
write.xlsx(obs.res_uPDI_ord,
           "results/ALSPAC/BF_obs.res_uPDI_ord.xlsx",
           overwrite = T)
obs.res_uPDI_ord <-
  read.xlsx("results/ALSPAC/BF_obs.res_uPDI_ord.xlsx")
...
### ...on PDI (continuous)
mod <-
  lm(PDI_z ~ IMD_Fam_cat + age_Mat_con + ethnic_Mat_bin, data = dat)
...
### ...on hPDI (continuous)
mod <-
  lm(hPDI_z ~ IMD_Fam_cat + age_Mat_con + ethnic_Mat_bin, data = dat)
...
### ...on uPDI (continuous)
mod <-
  lm(uPDI_z ~ IMD_Fam_cat + age_Mat_con + ethnic_Mat_bin, data = dat)
...
write.xlsx(
  obs.res_PDI.hPDI.uPDI_SEP,
  "results/ALSPAC/BF_obs.res_PDI.hPDI.uPDI_SEP.xlsx",
  overwrite = T
)
obs.res_PDI.hPDI.uPDI_SEP <-
  read.xlsx("results/ALSPAC/BF_obs.res_PDI.hPDI.uPDI_SEP.xlsx")
...
ggsave(
  "results/ALSPAC/BF_obs.forest_PDI.hPDI.uPDI_SEP.png",
