...
# This script is to perform negative control outcome analysis (with imputed data) on breastfeeding for MODIFIED plant-based diet indices (mPDIs) in Project Viva.
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_ord,
  "results/Viva/IMP_BF_obs.tbl_PDIm.hPDIm.uPDIm_ord.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_ord <-
  read.xlsx("results/Viva/IMP_BF_obs.tbl_PDIm.hPDIm.uPDIm_ord.xlsx")
...
write.xlsx(obs.res_PDI_ord,
           "results/Viva/IMP_BF_obs.res_PDIm_ord.xlsx",
           overwrite = T)
obs.res_PDI_ord <-
  read.xlsx("results/Viva/IMP_BF_obs.res_PDIm_ord.xlsx")
...
write.xlsx(obs.res_hPDI_ord,
           "results/Viva/IMP_BF_obs.res_hPDIm_ord.xlsx",
           overwrite = T)
obs.res_hPDI_ord <-
  read.xlsx("results/Viva/IMP_BF_obs.res_hPDIm_ord.xlsx")
...
write.xlsx(obs.res_uPDI_ord,
           "results/Viva/IMP_BF_obs.res_uPDIm_ord.xlsx",
           overwrite = T)
obs.res_uPDI_ord <-
  read.xlsx("results/Viva/IMP_BF_obs.res_uPDIm_ord.xlsx")
...
for (i in 1:dat_imp$m) {
  mod[[i]] <-
    lm(PDI_z ~ income_Fam_3cat + age_Mat_con + ethnic_Mat_bin, data = dat[[i]])
}
mod_pooled <- pool(mod)
...
for (i in 1:dat_imp$m) {
  mod[[i]] <-
    lm(hPDI_z ~ income_Fam_3cat + age_Mat_con + ethnic_Mat_bin, data = dat[[i]])
}
mod_pooled <- pool(mod)
...
for (i in 1:dat_imp$m) {
  mod[[i]] <-
    lm(uPDI_z ~ income_Fam_3cat + age_Mat_con + ethnic_Mat_bin, data = dat[[i]])
}
mod_pooled <- pool(mod)
...
write.xlsx(
  obs.res_PDI.hPDI.uPDI_SEP,
  "results/Viva/IMP_BF_obs.res_PDIm.hPDIm.uPDIm_SEP.xlsx",
  overwrite = T
)
obs.res_PDI.hPDI.uPDI_SEP <-
  read.xlsx("results/Viva/IMP_BF_obs.res_PDIm.hPDIm.uPDIm_SEP.xlsx")
...
ggsave(
  "results/Viva/IMP_BF_obs.forest_PDIm.hPDIm.uPDIm_SEP.png",
