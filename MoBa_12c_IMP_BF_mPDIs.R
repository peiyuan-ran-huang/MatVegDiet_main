...
# This script is to perform negative control outcome analysis (with imputed data) on breastfeeding for MODIFIED plant-based diet indices (mPDIs) in MoBa.
...
for (i in 1:dat_imp$m) {
  mod_2[[i]] <-
    clm(
      bf_dur_4c ~ PDIm_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + sex_Chi_bin,
      data = dat[[i]]
    )
}
...
for (i in 1:dat_imp$m) {
  mod_3[[i]] <-
    clm(
      bf_dur_4c ~ PDIm_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + sex_Chi_bin + any.supp_Mat_EAR.p_bin,
      data = dat[[i]]
    )
}
...
for (i in 1:dat_imp$m) {
  mod_5[[i]] <-
    clm(
      bf_dur_4c ~ hPDIm_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + sex_Chi_bin,
      data = dat[[i]]
    )
}
...
for (i in 1:dat_imp$m) {
  mod_6[[i]] <-
    clm(
      bf_dur_4c ~ hPDIm_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + sex_Chi_bin + any.supp_Mat_EAR.p_bin,
      data = dat[[i]]
    )
}
...
for (i in 1:dat_imp$m) {
  mod_8[[i]] <-
    clm(
      bf_dur_4c ~ uPDIm_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + sex_Chi_bin,
      data = dat[[i]]
    )
}
...
for (i in 1:dat_imp$m) {
  mod_9[[i]] <-
    clm(
      bf_dur_4c ~ uPDIm_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + sex_Chi_bin + any.supp_Mat_EAR.p_bin,
      data = dat[[i]]
    )
}
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_ord,
  "results/IMP_BF_obs.tbl_PDIm.hPDIm.uPDIm_ord.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_ord <-
  read.xlsx("results/IMP_BF_obs.tbl_PDIm.hPDIm.uPDIm_ord.xlsx")
...
write.xlsx(obs.res_PDI_ord,
           "results/IMP_BF_obs.res_PDIm_ord.xlsx",
           overwrite = T)
obs.res_PDI_ord <-
  read.xlsx("results/IMP_BF_obs.res_PDIm_ord.xlsx")
...
write.xlsx(obs.res_hPDI_ord,
           "results/IMP_BF_obs.res_hPDIm_ord.xlsx",
           overwrite = T)
obs.res_hPDI_ord <-
  read.xlsx("results/IMP_BF_obs.res_hPDIm_ord.xlsx")
...
write.xlsx(obs.res_uPDI_ord,
           "results/IMP_BF_obs.res_uPDIm_ord.xlsx",
           overwrite = T)
obs.res_uPDI_ord <-
  read.xlsx("results/IMP_BF_obs.res_uPDIm_ord.xlsx")
...
for (i in 1:dat_imp$m) {
  mod[[i]] <-
    lm(PDIm_z ~ income_Fam_3cat + age_Mat_con + ethnic_Mat_bin, data = dat[[i]])
}
mod_pooled <- pool(mod)
...
for (i in 1:dat_imp$m) {
  mod[[i]] <-
    lm(hPDIm_z ~ income_Fam_3cat + age_Mat_con + ethnic_Mat_bin,
       data = dat[[i]])
}
mod_pooled <- pool(mod)
...
for (i in 1:dat_imp$m) {
  mod[[i]] <-
    lm(uPDIm_z ~ income_Fam_3cat + age_Mat_con + ethnic_Mat_bin,
       data = dat[[i]])
}
mod_pooled <- pool(mod)
...
write.xlsx(
  obs.res_PDI.hPDI.uPDI_SEP,
  "results/IMP_BF_obs.res_PDIm.hPDIm.uPDIm_SEP.xlsx",
  overwrite = T
)
obs.res_PDI.hPDI.uPDI_SEP <-
  read.xlsx("results/IMP_BF_obs.res_PDIm.hPDIm.uPDIm_SEP.xlsx")
...
ggsave(
  "results/IMP_BF_obs.forest_PDIm.hPDIm.uPDIm_SEP.png",
