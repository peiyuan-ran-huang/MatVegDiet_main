...
write.xlsx(
  obs.res_VegDiet_bin,
  "results/IMP_STRAT.iron_obs.res_VegDiet_bin.xlsx",
  overwrite = T
)
obs.res_VegDiet_bin <-
  read.xlsx("results/IMP_STRAT.iron_obs.res_VegDiet_bin.xlsx")
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/IMP_STRAT.iron_obs.forest_VegDiet_bin.png",
  height = 2,
  width = 6
)
