...
# This script is to perform main association analysis (with imputed data) for quintiles of plant-based diet indices (PDIs) in ALSPAC.
...
for (myoutcome in ALSPAC_out_bin) {
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_5[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_6[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_8[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_9[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]],
        family = binomial
      )
  }
...
write.xlsx(
  obs.res_PDI_bin,
  "results/ALSPAC/IMP_MAIN_obs.res_PDI.quintile_bin.xlsx",
  overwrite = T
)
...
write.xlsx(
  obs.res_hPDI_bin,
  "results/ALSPAC/IMP_MAIN_obs.res_hPDI.quintile_bin.xlsx",
  overwrite = T
)
...
write.xlsx(
  obs.res_uPDI_bin,
  "results/ALSPAC/IMP_MAIN_obs.res_uPDI.quintile_bin.xlsx",
  overwrite = T
)
...
for (myoutcome in ALSPAC_out_con) {
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_2_pooled <- pool(mod_2)
  y_2 <- IMP_extract_beta.SE_cat(mod_2_pooled)
  ...
  for (i in 1:dat_imp$m) {
    mod_5[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_5_pooled <- pool(mod_5)
  y_5 <- IMP_extract_beta.SE_cat(mod_5_pooled)
  ...
  for (i in 1:dat_imp$m) {
    mod_8[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_5Q"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["IMD_Fam_cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_8_pooled <- pool(mod_8)
  y_8 <- IMP_extract_beta.SE_cat(mod_8_pooled)
...
write.xlsx(
  obs.res_PDI_con,
  "results/ALSPAC/IMP_MAIN_obs.res_PDI.quintile_con.xlsx",
  overwrite = T
)
...
write.xlsx(
  obs.res_hPDI_con,
  "results/ALSPAC/IMP_MAIN_obs.res_hPDI.quintile_con.xlsx",
  overwrite = T
)
...
write.xlsx(
  obs.res_uPDI_con,
  "results/ALSPAC/IMP_MAIN_obs.res_uPDI.quintile_con.xlsx",
  overwrite = T
)
