...
# This script is to perform main association analysis (with imputed data) for vegetarian diets in Project Viva.
...
write.xlsx(
  obs.tbl_VegDiet_bin,
  "results/Viva/IMP_MAIN_obs.tbl_VegDiet_bin.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_bin <-
  read.xlsx("results/Viva/IMP_MAIN_obs.tbl_VegDiet_bin.xlsx")
...
write.xlsx(
  obs.res_VegDiet_bin,
  "results/Viva/IMP_MAIN_obs.res_VegDiet_bin.xlsx",
  overwrite = T
)
obs.res_VegDiet_bin <-
  read.xlsx("results/Viva/IMP_MAIN_obs.res_VegDiet_bin.xlsx")
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/Viva/IMP_MAIN_obs.forest_VegDiet_bin.png",
  height = 4,
  width = 8
)
...
write.xlsx(
  obs.tbl_VegDiet_con,
  "results/Viva/IMP_MAIN_obs.tbl_VegDiet_con.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_con <-
  read.xlsx("results/Viva/IMP_MAIN_obs.tbl_VegDiet_con.xlsx")
...
write.xlsx(
  obs.res_VegDiet_con,
  "results/Viva/IMP_MAIN_obs.res_VegDiet_con.xlsx",
  overwrite = T
)
obs.res_VegDiet_con <-
  read.xlsx("results/Viva/IMP_MAIN_obs.res_VegDiet_con.xlsx")
...
ggsave(
  obs.forest_VegDiet_con,
  file = "results/Viva/IMP_MAIN_obs.forest_VegDiet_con.png",
  height = 2,
  width = 6
)
