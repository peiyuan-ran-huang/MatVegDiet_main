...
# Last edited date: 02-May-2025
# This script is to combine cohort-specific results of stratification (by iron supplementation) analysis for vegetarian diets.
...
obs.res_VegDiet_bin_ALSPAC <-
  read.xlsx("ALSPAC/STRAT.iron_obs.res_VegDiet_bin.xlsx")
...
obs.res_VegDiet_bin_BiB <-
  read.xlsx("BiB/STRAT.iron_obs.res_VegDiet_bin.xlsx")
...
obs.res_VegDiet_bin_MoBa <-
  read.xlsx("MoBa/STRAT.iron_obs.res_VegDiet_bin.xlsx")
...
obs.res_VegDiet_bin_Viva <-
  read.xlsx("Viva/STRAT.iron_obs.res_VegDiet_bin.xlsx")
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "ALL/Comb_STRAT.iron_obs.forest_VegDiet_bin.png",
  height = 7,
  width = 6
)
