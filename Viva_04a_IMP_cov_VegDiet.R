...
# This script is to examine the association/effect of key covariates with/on vegetarianism (with imputed data) in Viva.
...
obs.res_VegDiet_bin$Covariate[obs.res_VegDiet_bin$Covariate == "income_Fam_3cat"] <- "Household income\n(higher vs. lower)"
...
obs.res_VegDiet_bin$Covariate[obs.res_VegDiet_bin$Covariate == "PDIm"] <- "Overall PDI"
obs.res_VegDiet_bin$Covariate[obs.res_VegDiet_bin$Covariate == "hPDIm"] <- "Healthful PDI"
obs.res_VegDiet_bin$Covariate[obs.res_VegDiet_bin$Covariate == "uPDIm"] <- "Unhealthful PDI"
...
write.xlsx(obs.res_VegDiet_bin,
           "results/Viva/IMP_cov_obs.res_VegDiet_bin.xlsx",
           overwrite = T)
