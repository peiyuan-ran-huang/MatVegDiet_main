...
# This script is to perform paternal negative control analysis for vegetarian diets in ALSPAC.
...
for (myoutcome in ALSPAC_out_bin) {
  ...
  mod_1 <-
    glm(dat[[myoutcome]] ~ dat[["VegDiet_bin"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]],
        family = binomial)
  ...
  mod_2 <-
    glm(
      dat[[myoutcome]] ~ dat[["VegDiet_bin"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]] + dat[["VegDiet_bin_Pat"]] + dat[["age_Pat_con"]] + dat[["ethnic_Pat_bin"]] + dat[["edu_Pat_3cat"]] + dat[["parity_Pat_bin"]] + dat[["BMI_Pat_EAR.p_con"]] + dat[["smoking_Pat_EAR.p_bin"]] + dat[["alcohol_Pat_EAR.p_bin"]],
      family = binomial
    )
  ...
  mod_3 <-
    glm(dat[[myoutcome]] ~ dat[["VegDiet_bin_Pat"]] + dat[["age_Pat_con"]] + dat[["ethnic_Pat_bin"]] + dat[["edu_Pat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Pat_bin"]] + dat[["BMI_Pat_EAR.p_con"]] + dat[["smoking_Pat_EAR.p_bin"]] + dat[["alcohol_Pat_EAR.p_bin"]] + dat[["sex_Chi_bin"]],
        family = binomial)
  ...
  mod_4 <-
    glm(
      dat[[myoutcome]] ~ dat[["VegDiet_bin_Pat"]] + dat[["age_Pat_con"]] + dat[["ethnic_Pat_bin"]] + dat[["edu_Pat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Pat_bin"]] + dat[["BMI_Pat_EAR.p_con"]] + dat[["smoking_Pat_EAR.p_bin"]] + dat[["alcohol_Pat_EAR.p_bin"]] + dat[["sex_Chi_bin"]] + dat[["VegDiet_bin"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]],
      family = binomial
    )
...
write.xlsx(obs.tbl_VegDiet_bin,
           "results/ALSPAC/PNC_obs.tbl_VegDiet_bin.xlsx",
           overwrite = T)
obs.tbl_VegDiet_bin <-
  read.xlsx("results/ALSPAC/PNC_obs.tbl_VegDiet_bin.xlsx")
...
write.xlsx(obs.res_VegDiet_bin,
           "results/ALSPAC/PNC_obs.res_VegDiet_bin.xlsx",
           overwrite = T)
obs.res_VegDiet_bin <-
  read.xlsx("results/ALSPAC/PNC_obs.res_VegDiet_bin.xlsx")
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/ALSPAC/PNC_obs.forest_VegDiet_bin.png",
  height = 18,
  width = 7
)
...
for (myoutcome in ALSPAC_out_con) {
  ...
  #### Model 1 (maternal model): VegDiet_bin + age, ethnicity, education, IMD, parity, BMI, smoking, alcohol, supplement use, offspring sex
  mod_1 <-
    lm(dat[[myoutcome]] ~ dat[["VegDiet_bin"]] + dat[["age_Mat_con"]] + dat[["ethnic_Mat_bin"]] + dat[["edu_Mat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Mat_bin"]] + dat[["BMI_Mat_PRE.p_con"]] + dat[["smoking_Mat_EAR.p_bin"]] + dat[["alcohol_Mat_EAR.p_bin"]] + dat[["sex_Chi_bin"]])
  ...
  #### Model 3 (paternal model): VegDiet_bin_Pat + age, ethnicity, education, IMD, number of children, BMI, smoking, alcohol, supplement use, offspring sex
  mod_3 <-
    lm(dat[[myoutcome]] ~ dat[["VegDiet_bin_Pat"]] + dat[["age_Pat_con"]] + dat[["ethnic_Pat_bin"]] + dat[["edu_Pat_3cat"]]  + dat[["IMD_Fam_cat"]] + dat[["parity_Pat_bin"]] + dat[["BMI_Pat_EAR.p_con"]] + dat[["smoking_Pat_EAR.p_bin"]] + dat[["alcohol_Pat_EAR.p_bin"]] + dat[["sex_Chi_bin"]])
...
write.xlsx(obs.tbl_VegDiet_con,
           "results/ALSPAC/PNC_obs.tbl_VegDiet_con.xlsx",
           overwrite = T)
obs.tbl_VegDiet_con <-
  read.xlsx("results/ALSPAC/PNC_obs.tbl_VegDiet_con.xlsx")
...
write.xlsx(obs.res_VegDiet_con,
           "results/ALSPAC/PNC_obs.res_VegDiet_con.xlsx",
           overwrite = T)
obs.res_VegDiet_con <-
  read.xlsx("results/ALSPAC/PNC_obs.res_VegDiet_con.xlsx")
...
ggsave(
  obs.forest_VegDiet_con,
  file = "results/ALSPAC/PNC_obs.forest_VegDiet_con.png",
  height = 5,
  width = 6
)
