...
obs.res_hPDI_bin_ALSPAC <-
  read.xlsx("ALSPAC/MAIN_obs.res_hPDI_bin.xlsx")
...
obs.res_hPDI_con_ALSPAC <-
  read.xlsx("ALSPAC/MAIN_obs.res_hPDI_con.xlsx")
...
obs.res_hPDI_ord_ALSPAC <-
  read.xlsx("ALSPAC/BF_obs.res_hPDI_ord.xlsx")
...
obs.res_hPDI_bin_MoBa <-
  read.xlsx("MoBa/MAIN_obs.res_hPDI_bin.xlsx")
...
obs.res_hPDI_con_MoBa <-
  read.xlsx("MoBa/MAIN_obs.res_hPDI_con.xlsx")
...
obs.res_hPDI_ord_MoBa <-
  read.xlsx("MoBa/BF_obs.res_hPDI_ord.xlsx")
...
obs.res_hPDI_bin_Viva <-
  read.xlsx("Viva/MAIN_obs.res_hPDI_bin.xlsx")
...
obs.res_hPDI_con_Viva <-
  read.xlsx("Viva/MAIN_obs.res_hPDI_con.xlsx")
...
obs.res_hPDI_ord_Viva <-
  read.xlsx("Viva/BF_obs.res_hPDI_ord.xlsx")
...
write.xlsx(metagen_obs.tbl_hPDI_bin,
           "ALL/MAIN_meta.tbl_hPDI_bin.xlsx",
           rowNames = F)
...
png(
  "ALL/MAIN_meta.forest_hPDI_bin_Preg.png",
  res = 300,
  height = 2750,
  width = 2100
)
...
png(
  "ALL/MAIN_meta.forest_hPDI_bin_Deli.png",
  res = 300,
  height = 5200,
  width = 2100
)
...
png(
  "ALL/MAIN_meta.forest_hPDI_bin_Post.png",
  res = 300,
  height = 1300,
  width = 2100
)
...
write.xlsx(metagen_obs.tbl_hPDI_con,
           "ALL/MAIN_meta.tbl_hPDI_con.xlsx",
           rowNames = F)
...
png(
  "ALL/MAIN_meta.forest_hPDI_con.png",
  res = 300,
  height = 1800,
  width = 2100
)
...
write.xlsx(metagen_obs.tbl_hPDI_ord,
           "ALL/MAIN_meta.tbl_hPDI_ord.xlsx",
           rowNames = F)
...
png(
  "ALL/MAIN_meta.forest_hPDI_ord.png",
  res = 300,
  height = 700,
  width = 2100
)
