...
## Sensitivity Analysis 1 - FFQ-based + self-defined vegetarianism (binary)
...
################################################################################
# Sensitivity Analysis 1 - Diet-based + self-defined vegetarianism (binary)
################################################################################
...
for (myoutcome in MoBa_out_bin) {
  ...
  N_x <-
    as.data.frame(c(paste0(nrow(dat_1[dat_1$VegDiet_bin_FFQ_self == 0 &
...
write.xlsx(
  obs.tbl_VegDiet_bin,
  "results/IMP_SENS.FFQ.self_obs.tbl_VegDiet_bin.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_bin <-
  read.xlsx("results/IMP_SENS.FFQ.self_obs.tbl_VegDiet_bin.xlsx")
...
write.xlsx(
  obs.res_VegDiet_bin,
  "results/IMP_SENS.FFQ.self_obs.res_VegDiet_bin.xlsx",
  overwrite = T
)
obs.res_VegDiet_bin <-
  read.xlsx("results/IMP_SENS.FFQ.self_obs.res_VegDiet_bin.xlsx")
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/IMP_SENS.FFQ.self_obs.forest_VegDiet_bin.png",
  height = 5,
  width = 8
)
...
for (myoutcome in MoBa_out_con) {
  ...
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin_FFQ_self"]])
  }
  mod_1_pooled <- pool(mod_1)
...
write.xlsx(
  obs.tbl_VegDiet_con,
  "results/IMP_SENS.FFQ.self_obs.tbl_VegDiet_con.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_con <-
  read.xlsx("results/IMP_SENS.FFQ.self_obs.tbl_VegDiet_con.xlsx")
...
write.xlsx(
  obs.res_VegDiet_con,
  "results/IMP_SENS.FFQ.self_obs.res_VegDiet_con.xlsx",
  overwrite = T
)
obs.res_VegDiet_con <-
  read.xlsx("results/IMP_SENS.FFQ.self_obs.res_VegDiet_con.xlsx")
...
ggsave(
  obs.forest_VegDiet_con,
  file = "results/IMP_SENS.FFQ.self_obs.forest_VegDiet_con.png",
  height = 2,
  width = 6
)
...
write.xlsx(
  obs.tbl_VegDiet_ord,
  "results/IMP_SENS.FFQ.self_obs.tbl_VegDiet_ord.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_ord <-
  read.xlsx("results/IMP_SENS.FFQ.self_obs.tbl_VegDiet_ord.xlsx")
...
write.xlsx(
  obs.res_VegDiet_ord,
  "results/IMP_SENS.FFQ.self_obs.res_VegDiet_ord.xlsx",
  overwrite = T
)
obs.res_VegDiet_ord <-
  read.xlsx("results/IMP_SENS.FFQ.self_obs.res_VegDiet_ord.xlsx")
