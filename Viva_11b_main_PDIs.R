...
# This script is to perform main association analysis for plant-based diet indices (PDIs) in Project Viva.
...
extract_log.res_con <- function(mymodel) {
  N <- paste0(sum(mymodel$y == 1), " / ", length(mymodel$y))  # Extract sample size
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_bin,
  "results/Viva/MAIN_obs.tbl_PDI.hPDI.uPDI_bin.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_bin <-
  read.xlsx("results/Viva/MAIN_obs.tbl_PDI.hPDI.uPDI_bin.xlsx")
...
write.xlsx(obs.res_PDI_bin,
           "results/Viva/MAIN_obs.res_PDI_bin.xlsx",
           overwrite = T)
obs.res_PDI_bin <-
  read.xlsx("results/Viva/MAIN_obs.res_PDI_bin.xlsx")
...
write.xlsx(obs.res_hPDI_bin,
           "results/Viva/MAIN_obs.res_hPDI_bin.xlsx",
           overwrite = T)
obs.res_hPDI_bin <-
  read.xlsx("results/Viva/MAIN_obs.res_hPDI_bin.xlsx")
...
write.xlsx(obs.res_uPDI_bin,
           "results/Viva/MAIN_obs.res_uPDI_bin.xlsx",
           overwrite = T)
obs.res_uPDI_bin <-
  read.xlsx("results/Viva/MAIN_obs.res_uPDI_bin.xlsx")
...
obs.res_PDI.hPDI.uPDI_bin <- obs.res_PDI.hPDI.uPDI_bin %>% arrange(Outcome)  # Make sure the outcomes appear in the right order
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_bin,
  file = "results/Viva/MAIN_obs.forest_PDI.hPDI.uPDI_bin.png",
  height = 10,
  width = 7
)
...
obs.tbl_PDI.hPDI.uPDI_con
dim(obs.tbl_PDI.hPDI.uPDI_con)  # 2 outcomes with 3 exposures in 3 models = 6 obs.
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_con,
  "results/Viva/MAIN_obs.tbl_PDI.hPDI.uPDI_con.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_con <-
  read.xlsx("results/Viva/MAIN_obs.tbl_PDI.hPDI.uPDI_con.xlsx")
...
write.xlsx(obs.res_PDI_con,
           "results/Viva/MAIN_obs.res_PDI_con.xlsx",
           overwrite = T)
obs.res_PDI_con <-
  read.xlsx("results/Viva/MAIN_obs.res_PDI_con.xlsx")
...
write.xlsx(obs.res_hPDI_con,
           "results/Viva/MAIN_obs.res_hPDI_con.xlsx",
           overwrite = T)
obs.res_hPDI_con <-
  read.xlsx("results/Viva/MAIN_obs.res_hPDI_con.xlsx")
...
write.xlsx(obs.res_uPDI_con,
           "results/Viva/MAIN_obs.res_uPDI_con.xlsx",
           overwrite = T)
obs.res_uPDI_con <-
  read.xlsx("results/Viva/MAIN_obs.res_uPDI_con.xlsx")
...
obs.res_PDI.hPDI.uPDI_con$Outcome <-
  factor(obs.res_PDI.hPDI.uPDI_con$Outcome,
         levels = unique(MRPREG_outcome_labels$label)[unique(MRPREG_outcome_labels$label) %in% obs.res_PDI.hPDI.uPDI_con$Outcome])
obs.res_PDI.hPDI.uPDI_con <- obs.res_PDI.hPDI.uPDI_con %>% arrange(Outcome)  # Make sure the outcomes appear in the right order
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_con,
  file = "results/Viva/MAIN_obs.forest_PDI.hPDI.uPDI_con.png",
  height = 3,
  width = 6
)
