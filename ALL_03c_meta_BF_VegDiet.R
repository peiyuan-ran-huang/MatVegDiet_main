...
# This script is to perform meta-analysis on (negative control outcome ???) analysis on breastfeeding results for vegetarian diets.
...
obs.res_VegDiet_ord_ALSPAC <-
  read.xlsx("ALSPAC/BF_obs.res_VegDiet_ord.xlsx")
...
obs.res_VegDiet_ord_BiB <-
  read.xlsx("BiB/BF_obs.res_VegDiet_ord.xlsx")
...
obs.res_VegDiet_ord_MoBa <-
  read.xlsx("MoBa/BF_obs.res_VegDiet_ord.xlsx")
...
obs.res_VegDiet_ord_Viva <-
  read.xlsx("Viva/BF_obs.res_VegDiet_ord.xlsx")
...
write.xlsx(metagen_obs.tbl_VegDiet_ord,
           "ALL/BF_meta.tbl_VegDiet_ord.xlsx",
           rowNames = F)
...
png(
  "ALL/BF_meta.forest_VegDiet_ord.png",
  res = 300,
  height = 800,
  width = 2200
)
...
### ALSPAC
obs.res_VegDiet_SEP_ALSPAC <- read.xlsx("ALSPAC/BF_obs.res_VegDiet_SEP.xlsx")
...
### BiB
obs.res_VegDiet_SEP_BiB <- read.xlsx("BiB/BF_obs.res_VegDiet_SEP.xlsx")
...
### MoBa
obs.res_VegDiet_SEP_MoBa <- read.xlsx("MoBa/BF_obs.res_VegDiet_SEP.xlsx")
...
### Project Viva
obs.res_VegDiet_SEP_Viva <- read.xlsx("Viva/BF_obs.res_VegDiet_SEP.xlsx")
...
ggsave(
  obs.forest_VegDiet_SEP,
  file = "ALL/BF_obs.forest_VegDiet_SEP_ALL.png",
  height = 6,
  width = 10
)
...
png(
  "ALL/Comb_BF.meta.forest_SEP.obs.forest_VegDiet.png",
  res = 300,
  height = 2300,
  width = 2800
)
