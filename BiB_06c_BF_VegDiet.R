...
# This script is to perform negative control outcome analysis on breastfeeding for vegetarian diets in BiB.
...
write.xlsx(obs.tbl_VegDiet_ord,
           "results/BiB/BF_obs.tbl_VegDiet_ord.xlsx",
           overwrite = T)
obs.tbl_VegDiet_ord <-
  read.xlsx("results/BiB/BF_obs.tbl_VegDiet_ord.xlsx")
...
write.xlsx(obs.res_VegDiet_ord,
           "results/BiB/BF_obs.res_VegDiet_ord.xlsx",
           overwrite = T)
obs.res_VegDiet_ord <-
  read.xlsx("results/BiB/BF_obs.res_VegDiet_ord.xlsx")
...
write.xlsx(obs.res_VegDiet_SEP,
           "results/BiB/BF_obs.res_VegDiet_SEP.xlsx",
           overwrite = T)
obs.res_VegDiet_SEP <-
  read.xlsx("results/BiB/BF_obs.res_VegDiet_SEP.xlsx")
...
ggsave(
  obs.forest_VegDiet_SEP,
  file = "results/BiB/BF_obs.forest_VegDiet_SEP.png",
  height = 2,
  width = 9
)
