...
## Sensitivity Analysis 3 - Dietary exposure in mid-pregnancy (adjusted for early pregnancy dietary exposure)
...
################################################################################
# Sensitivity Analysis 2 - Dietary exposure in mid-pregnancy
################################################################################
...
for (i in 1:dat_imp$m) {
  ...
  dat[[i]] <- complete_dat
  dat[[i]] <- subset(dat[[i]], !is.na(dat[[i]]$PDI_2_z))
}

## Check the first imputed dataset
dat_1 <- dat[[1]]
head(dat_1)
dim(dat_1)  # 1872 -> 1641 (with available data on mid-pregnancy PDIs)
...
for (myoutcome in Viva_out_bin) {
  ...
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_2_z"]], family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_MID.p_bin"]] + dat[[i]][["energy_Mat_MID.p_con"]] + dat[[i]][["PDI_1_z"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_4[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_2_z"]], family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_5[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_6[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_MID.p_bin"]] + dat[[i]][["energy_Mat_MID.p_con"]] + dat[[i]][["hPDI_1_z"]],
        family = binomial
      )
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_7[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_2_z"]], family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_8[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_9[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_MID.p_bin"]] + dat[[i]][["energy_Mat_MID.p_con"]] + dat[[i]][["uPDI_1_z"]],
        family = binomial
      )
  }
  ...
  x <-
    cbind(
      ...
      N = as.data.frame(c(
        paste0(nrow(dat_1[!is.na(dat_1[["PDI_2_z"]]) &
                            !is.na(dat_1[[myoutcome]]) &
                            dat_1[[myoutcome]] == 1, ]), " / ", nrow(dat_1[!is.na(dat_1[["PDI_2_z"]]) &
                                                                             !is.na(dat_1[[myoutcome]]), ])),
        paste0(nrow(dat_1[!is.na(dat_1[["hPDI_2_z"]]) &
                            !is.na(dat_1[[myoutcome]]) &
                            dat_1[[myoutcome]] == 1, ]), " / ", nrow(dat_1[!is.na(dat_1[["hPDI_2_z"]]) &
                                                                             !is.na(dat_1[[myoutcome]]), ])),
        paste0(nrow(dat_1[!is.na(dat_1[["uPDI_2_z"]]) &
                            !is.na(dat_1[[myoutcome]]) &
                            dat_1[[myoutcome]] == 1, ]), " / ", nrow(dat_1[!is.na(dat_1[["uPDI_2_z"]]) &
                                                                             !is.na(dat_1[[myoutcome]]), ]))
      )),
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_bin,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.tbl_PDI.hPDI.uPDI_bin.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_bin <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.tbl_PDI.hPDI.uPDI_bin.xlsx")
...
write.xlsx(
  obs.res_PDI_bin,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_PDI_bin.xlsx",
  overwrite = T
)
obs.res_PDI_bin <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_PDI_bin.xlsx")
...
write.xlsx(
  obs.res_hPDI_bin,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_hPDI_bin.xlsx",
  overwrite = T
)
obs.res_hPDI_bin <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_hPDI_bin.xlsx")
...
write.xlsx(
  obs.res_uPDI_bin,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_uPDI_bin.xlsx",
  overwrite = T
)
obs.res_uPDI_bin <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_uPDI_bin.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_bin,
  file = "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.forest_PDI.hPDI.uPDI_bin.png",
  height = 10,
  width = 7
)
...
for (myoutcome in Viva_out_con) {
  ...
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_2_z"]])
  }
  mod_1_pooled <- pool(mod_1)
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["PDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_2_pooled <- pool(mod_2)
  ...
  for (i in 1:dat_imp$m) {
    mod_4[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_2_z"]])
  }
  mod_4_pooled <- pool(mod_4)
  ...
  for (i in 1:dat_imp$m) {
    mod_5[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["hPDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_5_pooled <- pool(mod_5)
  ...
  for (i in 1:dat_imp$m) {
    mod_7[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_2_z"]])
  }
  mod_7_pooled <- pool(mod_7)
  ...
  for (i in 1:dat_imp$m) {
    mod_8[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["uPDI_2_z"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_MID.p_bin"]] + dat[[i]][["alcohol_Mat_MID.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_8_pooled <- pool(mod_8)
  ...
  x <-
    cbind(
      ...
      Exposure = as.data.frame(c("PDI", "hPDI", "uPDI")),
      N = as.data.frame(c(
        nrow(dat_1[!is.na(dat_1[["PDI_2_z"]]) &
                     !is.na(dat_1[[myoutcome]]), ]), nrow(dat_1[!is.na(dat_1[["hPDI_2_z"]]) &
                                                                  !is.na(dat_1[[myoutcome]]), ]), nrow(dat_1[!is.na(dat_1[["uPDI_2_z"]]) &
                                                                                                               !is.na(dat_1[[myoutcome]]), ])
      )),
      Model_1 = rbind(x_1, x_4, x_7),
      space = " ",
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_con,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.tbl_PDI.hPDI.uPDI_con.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_con <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.tbl_PDI.hPDI.uPDI_con.xlsx")
...
write.xlsx(
  obs.res_PDI_con,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_PDI_con.xlsx",
  overwrite = T
)
obs.res_PDI_con <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_PDI_con.xlsx")
...
write.xlsx(
  obs.res_hPDI_con,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_hPDI_con.xlsx",
  overwrite = T
)
obs.res_hPDI_con <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_hPDI_con.xlsx")
...
write.xlsx(
  obs.res_uPDI_con,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_uPDI_con.xlsx",
  overwrite = T
)
obs.res_uPDI_con <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_uPDI_con.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_con,
  file = "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.forest_PDI.hPDI.uPDI_con.png",
  height = 3,
  width = 7
)
...
for (i in 1:dat_imp$m) {
  mod_1[[i]] <-
    clm(bf_dur_4c ~ PDI_2_z, data = dat[[i]])
}
mod_1_pooled <- pool(mod_1)
...
for (i in 1:dat_imp$m) {
  mod_2[[i]] <-
    clm(
      bf_dur_4c ~ PDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin,
      data = dat[[i]]
    )
}
mod_2_pooled <- pool(mod_2)
...
for (i in 1:dat_imp$m) {
  mod_3[[i]] <-
    clm(
      bf_dur_4c ~ PDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin + any.supp_Mat_MID.p_bin + PDI_1_z,
      data = dat[[i]]
    )
}
mod_3_pooled <- pool(mod_3)
...
for (i in 1:dat_imp$m) {
  mod_4[[i]] <-
    clm(bf_dur_4c ~ hPDI_2_z, data = dat[[i]])
}
mod_4_pooled <- pool(mod_4)
...
for (i in 1:dat_imp$m) {
  mod_5[[i]] <-
    clm(
      bf_dur_4c ~ hPDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin,
      data = dat[[i]]
    )
}
mod_5_pooled <- pool(mod_5)
...
for (i in 1:dat_imp$m) {
  mod_6[[i]] <-
    clm(
      bf_dur_4c ~ hPDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin + any.supp_Mat_MID.p_bin + hPDI_1_z,
      data = dat[[i]]
    )
}
mod_6_pooled <- pool(mod_6)
...
for (i in 1:dat_imp$m) {
  mod_7[[i]] <-
    clm(bf_dur_4c ~ uPDI_2_z, data = dat[[i]])
}
mod_7_pooled <- pool(mod_7)
...
for (i in 1:dat_imp$m) {
  mod_8[[i]] <-
    clm(
      bf_dur_4c ~ uPDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin,
      data = dat[[i]]
    )
}
mod_8_pooled <- pool(mod_8)
...
for (i in 1:dat_imp$m) {
  mod_9[[i]] <-
    clm(
      bf_dur_4c ~ uPDI_2_z + age_Mat_con + ethnic_Mat_bin + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_MID.p_bin + alcohol_Mat_MID.p_bin + sex_Chi_bin + any.supp_Mat_MID.p_bin + uPDI_1_z,
      data = dat[[i]]
    )
}
mod_9_pooled <- pool(mod_9)
...
x <-
  cbind(
    Outcome = as.data.frame(rep(outcome, 3)),
    Exposure = as.data.frame(c("PDI", "hPDI", "uPDI")),
    N = as.data.frame(c(nrow(dat_1[!is.na(dat_1$PDI_2_z) &
                                     !is.na(dat_1$bf_dur_4c), ]), nrow(dat_1[!is.na(dat_1$hPDI_2_z) &
                                                                               !is.na(dat_1$bf_dur_4c), ]), nrow(dat_1[!is.na(dat_1$uPDI_2_z) &
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_ord,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.tbl_PDI.hPDI.uPDI_ord.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_ord <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.tbl_PDI.hPDI.uPDI_ord.xlsx")
...
write.xlsx(
  obs.res_PDI_ord,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_PDI_ord.xlsx",
  overwrite = T
)
obs.res_PDI_ord <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_PDI_ord.xlsx")
...
write.xlsx(
  obs.res_hPDI_ord,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_hPDI_ord.xlsx",
  overwrite = T
)
obs.res_hPDI_ord <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_hPDI_ord.xlsx")
...
write.xlsx(
  obs.res_uPDI_ord,
  "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_uPDI_ord.xlsx",
  overwrite = T
)
obs.res_uPDI_ord <-
  read.xlsx("results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.res_uPDI_ord.xlsx")
...
ggsave(
  obs.forest_PDI.hPDI.uPDI_ord,
  file = "results/Viva/IMP_SENS.MID.p_adj.EAR.p_obs.forest_PDI.hPDI.uPDI_ord.png",
  height = 2,
  width = 7
)
