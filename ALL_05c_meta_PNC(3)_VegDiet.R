...
# This script is to perform meta-analysis on paternal negative control analysis results for vegetarian diets.
...
## ALL binary outcomes
metaforest_obs.res_VegDiet_bin_Mat1 <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Mat1.png")
metaforest_obs.res_VegDiet_bin_Mat2 <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Mat2.png")
metaforest_obs.res_VegDiet_bin_Pat1 <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Pat1.png")
metaforest_obs.res_VegDiet_bin_Pat2 <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Pat2.png")

### Binary pregnancy outcomes
metaforest_obs.res_VegDiet_bin_Mat1_Preg <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Mat1_Preg.png")
metaforest_obs.res_VegDiet_bin_Mat2_Preg <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Mat2_Preg.png")
metaforest_obs.res_VegDiet_bin_Pat1_Preg <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Pat1_Preg.png")
metaforest_obs.res_VegDiet_bin_Pat2_Preg <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Pat2_Preg.png")

### Binary delivery outcomes
metaforest_obs.res_VegDiet_bin_Mat1_Deli <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Mat1_Deli.png")
metaforest_obs.res_VegDiet_bin_Mat2_Deli <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Mat2_Deli.png")
metaforest_obs.res_VegDiet_bin_Pat1_Deli <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Pat1_Deli.png")
metaforest_obs.res_VegDiet_bin_Pat2_Deli <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Pat2_Deli.png")

### Binary postnatal outcomes
metaforest_obs.res_VegDiet_bin_Mat1_Post <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Mat1_Post.png")
metaforest_obs.res_VegDiet_bin_Mat2_Post <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Mat2_Post.png")
metaforest_obs.res_VegDiet_bin_Pat1_Post <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Pat1_Post.png")
metaforest_obs.res_VegDiet_bin_Pat2_Post <- readPNG("ALL/PNC_meta.forest_VegDiet_bin_Pat2_Post.png")

################################################################################

## Continuous outcomes
metaforest_obs.res_VegDiet_con_Mat1 <- readPNG("ALL/PNC_meta.forest_VegDiet_con_Mat1.png")
metaforest_obs.res_VegDiet_con_Mat2 <- readPNG("ALL/PNC_meta.forest_VegDiet_con_Mat2.png")
metaforest_obs.res_VegDiet_con_Pat1 <- readPNG("ALL/PNC_meta.forest_VegDiet_con_Pat1.png")
metaforest_obs.res_VegDiet_con_Pat2 <- readPNG("ALL/PNC_meta.forest_VegDiet_con_Pat2.png")

################################################################################

## Ordinal outcome (breastfeeding duration)
metaforest_obs.res_VegDiet_ord_Mat1 <- readPNG("ALL/PNC_meta.forest_VegDiet_ord_Mat1.png")
metaforest_obs.res_VegDiet_ord_Mat2 <- readPNG("ALL/PNC_meta.forest_VegDiet_ord_Mat2.png")
metaforest_obs.res_VegDiet_ord_Pat1 <- readPNG("ALL/PNC_meta.forest_VegDiet_ord_Pat1.png")
metaforest_obs.res_VegDiet_ord_Pat2 <- readPNG("ALL/PNC_meta.forest_VegDiet_ord_Pat2.png")
...
png(
  "ALL/Comb_PNC_meta.forest_VegDiet_bin.png",
  res = 300,
  height = 6650,
  width = 10500
)
...
png(
  "ALL/Comb_PNC_meta.forest_VegDiet_bin_Preg.png",
  res = 300,
  height = 2300,
  width = 10500
)
...
png(
  "ALL/Comb_PNC_meta.forest_VegDiet_bin_Deli.png",
  res = 300,
  height = 4000,
  width = 10500
)
...
png(
  "ALL/Comb_PNC_meta.forest_VegDiet_bin_Post.png",
  res = 300,
  height = 1150,
  width = 10500
)
...
png(
  "ALL/Comb_PNC_meta.forest_VegDiet_con.png",
  res = 300,
  height = 1900,
  width = 8500
)
...
png(
  "ALL/Comb_PNC_BF_meta.forest_VegDiet_ord.png",
  res = 300,
  height = 780,
  width = 8500
)
