...
for (i in 1:dat_imp$m) {
  mod_3[[i]] <-
    clm(dat[[i]][["bf_dur_4c"]] ~ dat[[i]][["VegDiet_bin_Pat"]] + dat[[i]][["age_Pat_con"]] + dat[[i]][["edu_Pat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Pat_bin"]] + dat[[i]][["BMI_Pat_EAR.p_con"]] + dat[[i]][["smoking_Pat_EAR.p_bin"]] + dat[[i]][["alcohol_Pat_EAR.p_bin"]] + dat[[i]][["any.supp_Pat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
}
...
write.xlsx(obs.tbl_VegDiet_ord,
           "results/IMP_PNC_BF_obs.tbl_VegDiet_ord.xlsx",
           overwrite = T)
obs.tbl_VegDiet_ord <-
  read.xlsx("results/IMP_PNC_BF_obs.tbl_VegDiet_ord.xlsx")
...
write.xlsx(obs.res_VegDiet_ord,
           "results/IMP_PNC_BF_obs.res_VegDiet_ord.xlsx",
           overwrite = T)
obs.res_VegDiet_ord <-
  read.xlsx("results/IMP_PNC_BF_obs.res_VegDiet_ord.xlsx")
