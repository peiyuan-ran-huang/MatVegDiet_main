...
# This script is to perform main association analysis (with imputed data) for vegetarian diets in MoBa.
...
for (myoutcome in MoBa_out_bin) {
  ...
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin"]], family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["energy_Mat_DUR.p_con"]] + dat[[i]][["hPDIm"]],
        family = binomial
      )
  }
  ...
  N_x <- as.data.frame(c(paste0(nrow(dat_1[dat_1$VegDiet_bin == 0 &
...
obs.tbl_VegDiet_bin
dim(obs.tbl_VegDiet_bin) # 22 outcomes * 2 categories = 42 obs in 3 models
write.xlsx(obs.tbl_VegDiet_bin,
           "results/IMP_MAIN_obs.tbl_VegDiet_bin.xlsx",
           overwrite = T)
obs.tbl_VegDiet_bin <-
  read.xlsx("results/IMP_MAIN_obs.tbl_VegDiet_bin.xlsx")
...
obs.res_VegDiet_bin
dim(obs.res_VegDiet_bin)  # 22 outcomes * 1 category * 3 models = 63 obs.
write.xlsx(obs.res_VegDiet_bin,
           "results/IMP_MAIN_obs.res_VegDiet_bin.xlsx",
           overwrite = T)
obs.res_VegDiet_bin <-
  read.xlsx("results/IMP_MAIN_obs.res_VegDiet_bin.xlsx")
...
head(obs.res_VegDiet_bin)
dim(obs.res_VegDiet_bin)  # 22 -> 22 obs.
################################################################################
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/IMP_MAIN_obs.forest_VegDiet_bin.png",
  height = 5,
  width = 8
)
...
for (myoutcome in MoBa_out_con) {
  ...
  mod_1 <- list()
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <- lm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin"]])
  }
  mod_1_pooled <- pool(mod_1)
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_bin"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["ethnic_Mat_bin"]] + dat[[i]][["edu_Mat_3cat"]] + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_2_pooled <- pool(mod_2)
...
write.xlsx(obs.tbl_VegDiet_con,
           "results/IMP_MAIN_obs.tbl_VegDiet_con.xlsx",
           overwrite = T)
obs.tbl_VegDiet_con <-
  read.xlsx("results/IMP_MAIN_obs.tbl_VegDiet_con.xlsx")
...
write.xlsx(obs.res_VegDiet_con,
           "results/IMP_MAIN_obs.res_VegDiet_con.xlsx",
           overwrite = T)
obs.res_VegDiet_con <-
  read.xlsx("results/IMP_MAIN_obs.res_VegDiet_con.xlsx")
...
ggsave(
  obs.forest_VegDiet_con,
  file = "results/IMP_MAIN_obs.forest_VegDiet_con.png",
  height = 2,
  width = 6
)
