...
# This script is to perform negative control outcome analysis (with imputed data) on breastfeeding for quintiles of plant-based diet indices (PDIs) in MoBa.
...
write.xlsx(obs.res_PDI_ord,
           "results/IMP_BF_obs.res_PDI.quintile_ord.xlsx",
           overwrite = T)
obs.res_PDI_ord <-
  read.xlsx("results/IMP_BF_obs.res_PDI.quintile_ord.xlsx")
...
write.xlsx(obs.res_hPDI_ord,
           "results/IMP_BF_obs.res_hPDI.quintile_ord.xlsx",
           overwrite = T)
obs.res_hPDI_ord <-
  read.xlsx("results/IMP_BF_obs.res_hPDI.quintile_ord.xlsx")
...
write.xlsx(obs.res_uPDI_ord,
           "results/IMP_BF_obs.res_uPDI.quintile_ord.xlsx",
           overwrite = T)
obs.res_uPDI_ord <-
  read.xlsx("results/IMP_BF_obs.res_uPDI.quintile_ord.xlsx")
