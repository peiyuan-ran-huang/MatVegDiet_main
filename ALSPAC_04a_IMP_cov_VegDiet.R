...
# This script is to examine the association/effect of key covariates with/on vegetarianism (with imputed data) in ALSPAC.
...
write.xlsx(
  obs.res_VegDiet_bin,
  "results/ALSPAC/IMP_cov_obs.res_VegDiet_bin.xlsx",
  overwrite = T
)
