...
write.xlsx(
  metagen_obs.tbl_VegDiet_bin_Mat,
  "ALL/PNC_meta.tbl_VegDiet_bin_Mat2.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Mat2.png",
  res = 300,
  height = 6700,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Mat2_Preg.png",
  res = 300,
  height = 2000,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Mat2_Deli.png",
  res = 300,
  height = 3800,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Mat2_Post.png",
  res = 300,
  height = 1300,
  width = 2600
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_bin_Pat,
  "ALL/PNC_meta.tbl_VegDiet_bin_Pat2.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Pat2.png",
  res = 300,
  height = 6700,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Pat2_Preg.png",
  res = 300,
  height = 2000,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Pat2_Deli.png",
  res = 300,
  height = 3800,
  width = 2600
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_bin_Pat2_Post.png",
  res = 300,
  height = 1300,
  width = 2600
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_con_Mat,
  "ALL/PNC_meta.tbl_VegDiet_con_Mat2.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_con_Mat2.png",
  res = 300,
  height = 1650,
  width = 2100
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_con_Pat,
  "ALL/PNC_meta.tbl_VegDiet_con_Pat2.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_con_Pat2.png",
  res = 300,
  height = 1650,
  width = 2100
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_ord_Mat,
  "ALL/PNC_meta.tbl_VegDiet_ord_Mat2.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_ord_Mat2.png",
  res = 300,
  height = 600,
  width = 2100
)
...
write.xlsx(
  metagen_obs.tbl_VegDiet_ord_Pat,
  "ALL/PNC_meta.tbl_VegDiet_ord_Pat2.xlsx",
  rowNames = F
)
...
png(
  "ALL/PNC_meta.forest_VegDiet_ord_Pat2.png",
  res = 300,
  height = 600,
  width = 2100
)
