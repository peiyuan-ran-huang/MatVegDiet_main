...
# This script is to perform main association analysis for vegetarian diets in MoBa.
...
write.xlsx(obs.tbl_VegDiet_bin,
           "results/MAIN_obs.tbl_VegDiet_bin.xlsx",
           overwrite = T)
obs.tbl_VegDiet_bin <-
  read.xlsx("results/MAIN_obs.tbl_VegDiet_bin.xlsx")
...
write.xlsx(obs.res_VegDiet_bin,
           "results/MAIN_obs.res_VegDiet_bin.xlsx",
           overwrite = T)
obs.res_VegDiet_bin <-
  read.xlsx("results/MAIN_obs.res_VegDiet_bin.xlsx")
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/MAIN_obs.forest_VegDiet_bin.png",
  height = 5,
  width = 8
)
...
write.xlsx(obs.tbl_VegDiet_con,
           "results/MAIN_obs.tbl_VegDiet_con.xlsx",
           overwrite = T)
obs.tbl_VegDiet_con <-
  read.xlsx("results/MAIN_obs.tbl_VegDiet_con.xlsx")
...
write.xlsx(obs.res_VegDiet_con,
           "results/MAIN_obs.res_VegDiet_con.xlsx",
           overwrite = T)
obs.res_VegDiet_con <-
  read.xlsx("results/MAIN_obs.res_VegDiet_con.xlsx")
...
ggsave(
  obs.forest_VegDiet_con,
  file = "results/MAIN_obs.forest_VegDiet_con.png",
  height = 2,
  width = 6
)
