...
# This script is to perform paternal negative control analysis (with imputed data) for vegetarian diets (in subgroups) in MoBa.
...
for (myoutcome in MoBa_out_bin) {
  ...
  #### Model 1 (maternal model): VegDiet_3cat + age, education, income, parity, BMI, smoking, alcohol, supplement use, offspring sex
  mod_1 <- list()
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_3cat"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_2[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_3cat"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["VegDiet_3cat_Pat"]] + dat[[i]][["age_Pat_con"]] + dat[[i]][["edu_Pat_3cat"]] + dat[[i]][["parity_Pat_bin"]] + dat[[i]][["BMI_Pat_EAR.p_con"]] + dat[[i]][["smoking_Pat_EAR.p_bin"]] + dat[[i]][["alcohol_Pat_EAR.p_bin"]] + dat[[i]][["any.supp_Pat_EAR.p_bin"]],
        family = binomial
      )
  }
  ...
  #### Model 3 (paternal model): VegDiet_3cat_Pat + age, education, income, number of children, BMI, smoking, alcohol, supplement use, offspring sex
  mod_3 <- list()
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      glm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_3cat_Pat"]] + dat[[i]][["age_Pat_con"]] + dat[[i]][["edu_Pat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Pat_bin"]] + dat[[i]][["BMI_Pat_EAR.p_con"]] + dat[[i]][["smoking_Pat_EAR.p_bin"]] + dat[[i]][["alcohol_Pat_EAR.p_bin"]] + dat[[i]][["any.supp_Pat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]],
          family = binomial)
  }
  ...
  for (i in 1:dat_imp$m) {
    mod_4[[i]] <-
      glm(
        dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_3cat_Pat"]] + dat[[i]][["age_Pat_con"]] + dat[[i]][["edu_Pat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Pat_bin"]] + dat[[i]][["BMI_Pat_EAR.p_con"]] + dat[[i]][["smoking_Pat_EAR.p_bin"]] + dat[[i]][["alcohol_Pat_EAR.p_bin"]] + dat[[i]][["any.supp_Pat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]] + dat[[i]][["VegDiet_3cat"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["edu_Mat_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]],
        family = binomial
      )
  }
...
write.xlsx(
  obs.tbl_VegDiet_bin,
  "results/IMP_PNC_obs.tbl_VegDiet.subgroup_bin.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_bin <-
  read.xlsx("results/IMP_PNC_obs.tbl_VegDiet.subgroup_bin.xlsx")
...
write.xlsx(
  obs.res_VegDiet_bin,
  "results/IMP_PNC_obs.res_VegDiet.subgroup_bin.xlsx",
  overwrite = T
)
obs.res_VegDiet_bin <-
  read.xlsx("results/IMP_PNC_obs.res_VegDiet.subgroup_bin.xlsx")
...
head(obs.res_VegDiet_bin)
dim(obs.res_VegDiet_bin)  # 168 -> 144 obs
################################################################################
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/IMP_PNC_obs.forest_VegDiet.subgroup_bin.png",
  height = 30,
  width = 7
)
...
for (myoutcome in MoBa_out_con) {
  ...
  for (i in 1:dat_imp$m) {
    mod_1[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_3cat"]] + dat[[i]][["age_Mat_con"]] + dat[[i]][["edu_Mat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Mat_bin"]] + dat[[i]][["BMI_Mat_PRE.p_con"]] + dat[[i]][["smoking_Mat_EAR.p_bin"]] + dat[[i]][["alcohol_Mat_EAR.p_bin"]] + dat[[i]][["any.supp_Mat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_1_pooled <- pool(mod_1)
  ...
  for (i in 1:dat_imp$m) {
    mod_3[[i]] <-
      lm(dat[[i]][[myoutcome]] ~ dat[[i]][["VegDiet_3cat_Pat"]] + dat[[i]][["age_Pat_con"]] + dat[[i]][["edu_Pat_3cat"]]  + dat[[i]][["income_Fam_3cat"]] + dat[[i]][["parity_Pat_bin"]] + dat[[i]][["BMI_Pat_EAR.p_con"]] + dat[[i]][["smoking_Pat_EAR.p_bin"]] + dat[[i]][["alcohol_Pat_EAR.p_bin"]] + dat[[i]][["any.supp_Pat_EAR.p_bin"]] + dat[[i]][["sex_Chi_bin"]])
  }
  mod_3_pooled <- pool(mod_3)
...
write.xlsx(
  obs.tbl_VegDiet_con,
  "results/IMP_PNC_obs.tbl_VegDiet.subgroup_con.xlsx",
  overwrite = T
)
obs.tbl_VegDiet_con <-
  read.xlsx("results/IMP_PNC_obs.tbl_VegDiet.subgroup_con.xlsx")
...
write.xlsx(
  obs.res_VegDiet_con,
  "results/IMP_PNC_obs.res_VegDiet.subgroup_con.xlsx",
  overwrite = T
)
obs.res_VegDiet_con <-
  read.xlsx("results/IMP_PNC_obs.res_VegDiet.subgroup_con.xlsx")
...
ggsave(
  obs.forest_VegDiet_con,
  file = "results/IMP_PNC_obs.forest_VegDiet.subgroup_con.png",
  height = 8,
  width = 6
)
