...
# This script is to perform paternal negative control analysis on breastfeeding duration for vegetarian diets in MoBa.
...
mod_1 <-
  clm(
    bf_dur_4c ~ VegDiet_bin + age_Mat_con + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + any.supp_Mat_EAR.p_bin + sex_Chi_bin,
    data = dat
  )
...
mod_2 <-
  clm(
    bf_dur_4c ~ VegDiet_bin + age_Mat_con + edu_Mat_3cat  + income_Fam_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + any.supp_Mat_EAR.p_bin + sex_Chi_bin + VegDiet_bin_Pat + age_Pat_con + edu_Pat_3cat + parity_Pat_bin + BMI_Pat_EAR.p_con + smoking_Pat_EAR.p_bin + alcohol_Pat_EAR.p_bin + any.supp_Pat_EAR.p_bin,
    data = dat
  )
...
mod_3 <-
  clm(
    bf_dur_4c ~ VegDiet_bin_Pat + age_Pat_con + edu_Pat_3cat  + income_Fam_3cat + parity_Pat_bin + BMI_Pat_EAR.p_con + smoking_Pat_EAR.p_bin + alcohol_Pat_EAR.p_bin + any.supp_Pat_EAR.p_bin + sex_Chi_bin,
    data = dat
  )
...
mod_4 <-
  clm(
    bf_dur_4c ~ VegDiet_bin_Pat + age_Pat_con + edu_Pat_3cat  + income_Fam_3cat + parity_Pat_bin + BMI_Pat_EAR.p_con + smoking_Pat_EAR.p_bin + alcohol_Pat_EAR.p_bin + any.supp_Pat_EAR.p_bin + sex_Chi_bin + VegDiet_bin + age_Mat_con + edu_Mat_3cat + parity_Mat_bin + BMI_Mat_PRE.p_con + smoking_Mat_EAR.p_bin + alcohol_Mat_EAR.p_bin + any.supp_Mat_EAR.p_bin,
    data = dat
  )
...
write.xlsx(obs.tbl_VegDiet_ord,
           "results/PNC_BF_obs.tbl_VegDiet_ord.xlsx",
           overwrite = T)
obs.tbl_VegDiet_ord <-
  read.xlsx("results/PNC_BF_obs.tbl_VegDiet_ord.xlsx")
...
write.xlsx(obs.res_VegDiet_ord,
           "results/PNC_BF_obs.res_VegDiet_ord.xlsx",
           overwrite = T)
obs.res_VegDiet_ord <-
  read.xlsx("results/PNC_BF_obs.res_VegDiet_ord.xlsx")
