...
# This script is to perform negative control outcome analysis (with imputed data) on breastfeeding for plant-based diet indices (PDIs) in Project Viva.
...
write.xlsx(
  obs.tbl_PDI.hPDI.uPDI_ord,
  "results/Viva/IMP_BF_obs.tbl_PDI.hPDI.uPDI_ord.xlsx",
  overwrite = T
)
obs.tbl_PDI.hPDI.uPDI_ord <-
  read.xlsx("results/Viva/IMP_BF_obs.tbl_PDI.hPDI.uPDI_ord.xlsx")
...
write.xlsx(obs.res_PDI_ord,
           "results/Viva/IMP_BF_obs.res_PDI_ord.xlsx",
           overwrite = T)
obs.res_PDI_ord <-
  read.xlsx("results/Viva/IMP_BF_obs.res_PDI_ord.xlsx")
...
write.xlsx(obs.res_hPDI_ord,
           "results/Viva/IMP_BF_obs.res_hPDI_ord.xlsx",
           overwrite = T)
obs.res_hPDI_ord <-
  read.xlsx("results/Viva/IMP_BF_obs.res_hPDI_ord.xlsx")
...
write.xlsx(obs.res_uPDI_ord,
           "results/Viva/IMP_BF_obs.res_uPDI_ord.xlsx",
           overwrite = T)
obs.res_uPDI_ord <-
  read.xlsx("results/Viva/IMP_BF_obs.res_uPDI_ord.xlsx")
...
write.xlsx(
  obs.res_PDI.hPDI.uPDI_SEP,
  "results/Viva/IMP_BF_obs.res_PDI.hPDI.uPDI_SEP.xlsx",
  overwrite = T
)
obs.res_PDI.hPDI.uPDI_SEP <-
  read.xlsx("results/Viva/IMP_BF_obs.res_PDI.hPDI.uPDI_SEP.xlsx")
...
ggsave(
  "results/Viva/IMP_BF_obs.forest_PDI.hPDI.uPDI_SEP.png",
