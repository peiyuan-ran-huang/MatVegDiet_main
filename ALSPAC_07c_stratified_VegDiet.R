...
# This script is to perform stratification analyses for vegetarian diets in ALSPAC.
...
write.xlsx(
  obs.res_VegDiet_bin,
  "results/ALSPAC/STRAT.iron_obs.res_VegDiet_bin.xlsx",
  overwrite = T
)
obs.res_VegDiet_bin <-
  read.xlsx("results/ALSPAC/STRAT.iron_obs.res_VegDiet_bin.xlsx")
...
ggsave(
  obs.forest_VegDiet_bin,
  file = "results/ALSPAC/STRAT.iron_obs.forest_VegDiet_bin.png",
  height = 2,
  width = 6
)
